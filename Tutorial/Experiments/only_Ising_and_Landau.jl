...
# homogeneousself!(g,a1)
# ### Set Qc*Jii
# g.hamiltonian[3].qc[] = b1/a1
# ### Set Sc*Jii
# g.hamiltonian[4].sc[] = c1/a1
...
pulsetime = fullsweep*2000
relaxtime = fullsweep*3000
...
Metro_simple = CompositeAlgorithm(metropolis, M_Logger, B_Logger, (1, fullsweep, fullsweep))

pulse_part1 = CompositeAlgorithm(Metro_simple, pulse1, (1, point_repeat))
pulse_part2 = CompositeAlgorithm(Metro_simple, pulse2, (1, point_repeat))
anneal_part1 = CompositeAlgorithm(Metro_simple, Anealing1, (1, point_repeat))

Pulse_and_Relax = Routine(pulse_part1, Metro_simple, 
    (pulsetime, relaxtime), 
...
outdir = raw"C:\Users\P317151\Documents\data\Model_V1.0\20260217\Landau term\a =-2 c=10 change T"
mkpath(outdir)
...
base_name = string(
    ...
    "_c1=", round(c1, digits=4),
    "_Eb=", round(E_barrier, digits=4),
    "_Epp=", round(Epp_1, digits=4),
    "_Temp=", round(Temperature, digits=4),
    "_", date_str
)
...
params = DataFrame(
    key = String[
        "JIsing","a1","b1","c1","E_barrier","Eypp_1","xL","yL","zL","Temperature","time_fctr",
        "anneal_time","pulsetime","relaxtime","point_repeat","Amp1","Amp2"
    ],
    value = Any[
        JIsing, a1, b1, c1, E_barrier, Epp_1, xL, yL, zL, Temperature, time_fctr,
        anneal_time, pulsetime, relaxtime, point_repeat, Amp1, Amp2
    ]
)
