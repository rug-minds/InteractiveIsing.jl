...
top:
  ...
  fence syncscope("singlethread") seq_cst
  store i8 1, ptr @"jl_global#9699.jit", align 32, !dbg !171, !tbaa !181, !alias.scope !184, !noalias !185
  ...
  %68 = call i64 @jlplt_ijl_hrtime_9701_got.jit(), !dbg !200
...
L36:                                              ; preds = %top
  %71 = call swiftcc [1 x ptr] @j_ArgumentError_9702(ptr nonnull swiftself %pgcstack, ptr nonnull @"jl_global#9703.jit"), !dbg !246
  ...
  %"box::ArgumentError" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load1374, i32 424, i32 16, i64 4841261040) #24, !dbg !246
  %"box::ArgumentError.tag_addr" = getelementptr inbounds i64, ptr %"box::ArgumentError", i64 -1, !dbg !246
  store atomic i64 4841261040, ptr %"box::ArgumentError.tag_addr" unordered, align 8, !dbg !246, !tbaa !273
...
L39:                                              ; preds = %top
  ...
  %76 = call swiftcc i64 @j_rand_9705(ptr nonnull swiftself %pgcstack, ptr %49, ptr nocapture nonnull readonly %"new::SamplerRangeNDL"), !dbg !254
...
L60:                                              ; preds = %L39
  call swiftcc void @j_throw_dmrsa_9706(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %.state.size.0.copyload) #8, !dbg !307
  unreachable, !dbg !307
...
L119:                                             ; preds = %L116
  %84 = call swiftcc i64 @j_gen_rand_9714(ptr nonnull swiftself %pgcstack, ptr %49), !dbg !347
...
L177:                                             ; preds = %L121
  %102 = call swiftcc double @j_rem_internal_9718(ptr nonnull swiftself %pgcstack, double %101, double 4.000000e+00), !dbg !425
...
L224:                                             ; preds = %L65
  ...
  %"box::Float64582" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load1379, i32 424, i32 16, i64 4841840784) #24, !dbg !445
  %"box::Float64582.tag_addr" = getelementptr inbounds i64, ptr %"box::Float64582", i64 -1, !dbg !445
  store atomic i64 4841840784, ptr %"box::Float64582.tag_addr" unordered, align 8, !dbg !445, !tbaa !273
  ...
  store ptr @"jl_global#9719.jit", ptr %jlcallframe1, align 8, !dbg !445
...
L297:                                             ; preds = %L242
  ...
  call swiftcc void @j_throw_boundserror_9716(ptr nonnull swiftself %pgcstack, ptr %11, ptr nocapture nonnull readonly %"new::Tuple547") #8, !dbg !474
  unreachable, !dbg !474
...
L300:                                             ; preds = %L242
  ...
  %121 = call swiftcc double @"j_#power_by_squaring#401_9709"(ptr nonnull swiftself %pgcstack, double %120, i64 signext 2), !dbg !485
...
L322:                                             ; preds = %L300
  ...
  call swiftcc void @j_throw_boundserror_9716(ptr nonnull swiftself %pgcstack, ptr nonnull %.state21, ptr nocapture nonnull readonly %"new::Tuple545") #8, !dbg !474
  unreachable, !dbg !474
...
L325:                                             ; preds = %L300
  ...
  %126 = call swiftcc double @"j_#power_by_squaring#401_9709"(ptr nonnull swiftself %pgcstack, double %125, i64 signext 2), !dbg !485
  ...
  store ptr %9, ptr %0, align 8, !dbg !471
  ...
  %136 = call swiftcc float @"j_#calculate##0_9710"(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %"new::#calculate##0#calculate##1", ptr nocapture nonnull readonly %0, float %131, ptr nocapture nonnull readonly %115, ptr nocapture nonnull readonly %3), !dbg !471
...
L380:                                             ; preds = %L325
  %139 = getelementptr inbounds ptr, ptr %gcframe2, i64 9
  %140 = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 104, !dbg !526
  store ptr %27, ptr %139, align 8, !dbg !519
  call swiftcc void @j_throw_boundserror_9717(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %140, ptr nocapture nonnull readonly %139, ptr nocapture nonnull readonly %"new::Tuple43") #8, !dbg !519
  unreachable, !dbg !519
...
L397:                                             ; preds = %L383
  ...
  call swiftcc void @j_throw_boundserror_9716(ptr nonnull swiftself %pgcstack, ptr nonnull %.state41, ptr nocapture nonnull readonly %"new::Tuple542") #8, !dbg !532
  unreachable, !dbg !532
...
L418:                                             ; preds = %L415
  %148 = call swiftcc i64 @j_gen_rand_9714(ptr nonnull swiftself %pgcstack, ptr %49), !dbg !546
...
L540:                                             ; preds = %L532
  call swiftcc void @j_throw_dmrsa_9706(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %.state56.size.0.copyload) #8, !dbg !630
  unreachable, !dbg !630
...
L666.lr.ph:                                       ; preds = %L641.L645_crit_edge
  ...
  %193 = getelementptr inbounds ptr, ptr %gcframe2, i64 11
  %194 = getelementptr inbounds ptr, ptr %gcframe2, i64 12
  %195 = getelementptr inbounds ptr, ptr %gcframe2, i64 13
  %196 = getelementptr inbounds ptr, ptr %gcframe2, i64 14
...
L663:                                             ; preds = %L641.L645_crit_edge
  %197 = call swiftcc [1 x ptr] @j_ArgumentError_9702(ptr nonnull swiftself %pgcstack, ptr nonnull @"jl_global#9703.jit"), !dbg !636
  ...
  %"box::ArgumentError143" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load1386, i32 424, i32 16, i64 4841261040) #24, !dbg !636
  %"box::ArgumentError143.tag_addr" = getelementptr inbounds i64, ptr %"box::ArgumentError143", i64 -1, !dbg !636
  store atomic i64 4841261040, ptr %"box::ArgumentError143.tag_addr" unordered, align 8, !dbg !636, !tbaa !273
...
L666:                                             ; preds = %L1254, %L666.lr.ph
  ...
  %201 = call swiftcc i64 @j_rand_9705(ptr nonnull swiftself %pgcstack, ptr %49, ptr nocapture nonnull readonly %"new::SamplerRangeNDL148"), !dbg !639
  %.fr = freeze i64 %201
...
L687:                                             ; preds = %L666
  call swiftcc void @j_throw_dmrsa_9706(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %root_phi106.state.size.0.copyload) #8, !dbg !659
  unreachable, !dbg !659
...
L746:                                             ; preds = %L743
  %208 = call swiftcc i64 @j_gen_rand_9714(ptr nonnull swiftself %pgcstack, ptr %49), !dbg !677
...
L804:                                             ; preds = %L748
  %226 = call swiftcc double @j_rem_internal_9718(ptr nonnull swiftself %pgcstack, double %225, double 4.000000e+00), !dbg !729
...
L851:                                             ; preds = %L692
  ...
  %"box::Float64" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load1391, i32 424, i32 16, i64 4841840784) #24, !dbg !749
  %"box::Float64.tag_addr" = getelementptr inbounds i64, ptr %"box::Float64", i64 -1, !dbg !749
  store atomic i64 4841840784, ptr %"box::Float64.tag_addr" unordered, align 8, !dbg !749, !tbaa !273
  ...
  store ptr @"jl_global#9719.jit", ptr %jlcallframe1, align 8, !dbg !749
...
L924:                                             ; preds = %L869
  ...
  call swiftcc void @j_throw_boundserror_9716(ptr nonnull swiftself %pgcstack, ptr nonnull %11, ptr nocapture nonnull readonly %"new::Tuple474") #8, !dbg !755
  unreachable, !dbg !755
...
L927:                                             ; preds = %L869
  ...
  %241 = call swiftcc double @"j_#power_by_squaring#401_9709"(ptr nonnull swiftself %pgcstack, double %240, i64 signext 2), !dbg !765
...
L949:                                             ; preds = %L927
  ...
  store ptr %value_phi88.state, ptr %gc_slot_addr_141358, align 8
  call swiftcc void @j_throw_boundserror_9716(ptr nonnull swiftself %pgcstack, ptr nonnull %value_phi88.state, ptr nocapture nonnull readonly %"new::Tuple472") #8, !dbg !755
  unreachable, !dbg !755
...
L952:                                             ; preds = %L927
  ...
  store ptr null, ptr %gc_slot_addr_141358, align 8
  %246 = call swiftcc double @"j_#power_by_squaring#401_9709"(ptr nonnull swiftself %pgcstack, double %245, i64 signext 2), !dbg !765
  ...
  store ptr %9, ptr %2, align 8, !dbg !745
  store ptr %17, ptr %1, align 8, !dbg !745
  ...
  %252 = call swiftcc float @"j_#calculate##0_9710"(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %"new::#calculate##0#calculate##1185", ptr nocapture nonnull readonly %2, float %251, ptr nocapture nonnull readonly %192, ptr nocapture nonnull readonly %1), !dbg !745
...
L1007:                                            ; preds = %L952
  %254 = getelementptr inbounds ptr, ptr %gcframe2, i64 2
  store i64 %.fr, ptr %"new::Tuple208", align 1, !dbg !742, !tbaa !283, !alias.scope !285, !noalias !286
  store ptr %27, ptr %254, align 8, !dbg !777
  call swiftcc void @j_throw_boundserror_9717(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %.sroa.91145.0..sroa_idx1148, ptr nocapture nonnull readonly %254, ptr nocapture nonnull readonly %"new::Tuple208") #8, !dbg !777
  unreachable, !dbg !777
...
L1024:                                            ; preds = %L1010
  ...
  call swiftcc void @j_throw_boundserror_9716(ptr nonnull swiftself %pgcstack, ptr nonnull %value_phi88.state206, ptr nocapture nonnull readonly %"new::Tuple469") #8, !dbg !781
  unreachable, !dbg !781
...
L1045:                                            ; preds = %L1042
  %262 = call swiftcc i64 @j_gen_rand_9714(ptr nonnull swiftself %pgcstack, ptr %49), !dbg !793
...
L1167:                                            ; preds = %L1159
  call swiftcc void @j_throw_dmrsa_9706(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %root_phi106.state221.size.0.copyload) #8, !dbg !862
  unreachable, !dbg !862
...
L1255:                                            ; preds = %L1250.L1255_crit_edge, %L1244, %L641.L1255_crit_edge
  ...
  %303 = call i64 @jlplt_ijl_hrtime_9701_got.jit(), !dbg !864
  ...
  %exactly_isa.not.not = icmp eq ptr %305, @"+Core.Nothing#9712.jit", !dbg !872
...
L1294:                                            ; preds = %L1255
  ...
  %"box::ProcessContext" = call noalias nonnull align 8 dereferenceable(400) ptr @ijl_gc_small_alloc(ptr %ptls_load1399, i32 1120, i32 400, i64 13104410000) #24, !dbg !877
  %"box::ProcessContext.tag_addr" = getelementptr inbounds i64, ptr %"box::ProcessContext", i64 -1, !dbg !877
  store atomic i64 13104410000, ptr %"box::ProcessContext.tag_addr" unordered, align 8, !dbg !877, !tbaa !273
