...
top:
  ...
  %0 = getelementptr inbounds ptr, ptr %gcframe2, i64 4
  ...
  fence syncscope("singlethread") seq_cst
  store i8 1, ptr @"jl_global#9536.jit", align 16, !dbg !172, !tbaa !187, !alias.scope !190, !noalias !191
  ...
  %66 = call i64 @jlplt_ijl_hrtime_9538_got.jit(), !dbg !206
  ...
  br i1 %.not.not, label %L34.L653_crit_edge, label %L34.L38_crit_edge, !dbg !231

L34.L653_crit_edge:                               ; preds = %top
...
L59.lr.ph:                                        ; preds = %L34.L38_crit_edge
  ...
  %87 = getelementptr inbounds ptr, ptr %gcframe2, i64 5
  %88 = getelementptr inbounds ptr, ptr %gcframe2, i64 6
  %89 = getelementptr inbounds ptr, ptr %gcframe2, i64 7
  %90 = getelementptr inbounds ptr, ptr %gcframe2, i64 8
...
L56:                                              ; preds = %L652, %L34.L38_crit_edge
  %92 = call swiftcc [1 x ptr] @j_ArgumentError_9539(ptr nonnull swiftself %pgcstack, ptr nonnull @"jl_global#9540.jit"), !dbg !255
  ...
  %"box::ArgumentError" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load956, i32 424, i32 16, i64 5004543984) #23, !dbg !255
  %"box::ArgumentError.tag_addr" = getelementptr inbounds i64, ptr %"box::ArgumentError", i64 -1, !dbg !255
  store atomic i64 5004543984, ptr %"box::ArgumentError.tag_addr" unordered, align 8, !dbg !255, !tbaa !281
...
L59:                                              ; preds = %L652, %L59.lr.ph
  %94 = phi i64 [ %"new::Tuple67.promoted", %L59.lr.ph ], [ %.fr785, %L652 ]
  %.unbox528 = phi i64 [ %.unbox524, %L59.lr.ph ], [ %.unbox, %L652 ]
  %.stop_ptr.unbox527 = phi i64 [ %.stop_ptr.unbox523, %L59.lr.ph ], [ %.stop_ptr.unbox, %L652 ]
  %value_phi5526 = phi i64 [ %"process::Process.loopidx", %L59.lr.ph ], [ %198, %L652 ]
  ...
  %97 = call swiftcc i64 @j_rand_9542(ptr nonnull swiftself %pgcstack, ptr %47, ptr nocapture nonnull readonly %"new::SamplerRangeNDL"), !dbg !263
  %.fr785 = freeze i64 %97
...
L80:                                              ; preds = %L59
  call swiftcc void @j_throw_dmrsa_9543(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %root_phi25.state.size.0.copyload) #9, !dbg !311
  unreachable, !dbg !311
...
L139:                                             ; preds = %L136
  %104 = call swiftcc i64 @j_gen_rand_9550(ptr nonnull swiftself %pgcstack, ptr %47), !dbg !350
...
L197:                                             ; preds = %L141
  %122 = call swiftcc double @j_rem_internal_9554(ptr nonnull swiftself %pgcstack, double %121, double 4.000000e+00), !dbg !428
...
L244:                                             ; preds = %L85
  ...
  %"box::Float64" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load961, i32 424, i32 16, i64 5005123728) #23, !dbg !462
  %"box::Float64.tag_addr" = getelementptr inbounds i64, ptr %"box::Float64", i64 -1, !dbg !462
  store atomic i64 5005123728, ptr %"box::Float64.tag_addr" unordered, align 8, !dbg !462, !tbaa !281
  ...
  store ptr @"jl_global#9555.jit", ptr %jlcallframe1, align 8, !dbg !462
...
L317:                                             ; preds = %L262
  ...
  call swiftcc void @j_throw_boundserror_9552(ptr nonnull swiftself %pgcstack, ptr %9, ptr nocapture nonnull readonly %"new::Tuple290") #9, !dbg !470
  unreachable, !dbg !470
...
L320:                                             ; preds = %L262
  ...
  %137 = call swiftcc double @"j_#power_by_squaring#401_9546"(ptr nonnull swiftself %pgcstack, double %136, i64 signext 2), !dbg !487
...
L342:                                             ; preds = %L320
  ...
  store ptr %root_phi6.state, ptr %gc_slot_addr_7947, align 8
  call swiftcc void @j_throw_boundserror_9552(ptr nonnull swiftself %pgcstack, ptr nonnull %root_phi6.state, ptr nocapture nonnull readonly %"new::Tuple288") #9, !dbg !470
  unreachable, !dbg !470
...
L345:                                             ; preds = %L320
  ...
  %142 = call swiftcc double @"j_#power_by_squaring#401_9546"(ptr nonnull swiftself %pgcstack, double %141, i64 signext 2), !dbg !487
  ...
  store ptr %7, ptr %1, align 8, !dbg !456
  store ptr %15, ptr %0, align 8, !dbg !456
  ...
  %148 = call swiftcc float @"j_#calculate##0_9547"(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %"new::#calculate##0#calculate##1", ptr nocapture nonnull readonly %1, float %147, ptr nocapture nonnull readonly %86, ptr nocapture nonnull readonly %0), !dbg !456
...
L400:                                             ; preds = %L345
  %150 = getelementptr inbounds ptr, ptr %gcframe2, i64 3
  store i64 %.fr785, ptr %"new::Tuple67", align 1, !dbg !447, !tbaa !277, !alias.scope !279, !noalias !280
  store ptr %25, ptr %150, align 8, !dbg !507
  call swiftcc void @j_throw_boundserror_9553(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %.sroa.0433.sroa.9.0..sroa_idx660, ptr nocapture nonnull readonly %150, ptr nocapture nonnull readonly %"new::Tuple67") #9, !dbg !507
  unreachable, !dbg !507
...
L417:                                             ; preds = %L403
  ...
  call swiftcc void @j_throw_boundserror_9552(ptr nonnull swiftself %pgcstack, ptr nonnull %root_phi6.state65, ptr nocapture nonnull readonly %"new::Tuple285") #9, !dbg !511
  unreachable, !dbg !511
...
L438:                                             ; preds = %L435
  %158 = call swiftcc i64 @j_gen_rand_9550(ptr nonnull swiftself %pgcstack, ptr %47), !dbg !525
...
L560:                                             ; preds = %L552
  call swiftcc void @j_throw_dmrsa_9543(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %root_phi25.state80.size.0.copyload) #9, !dbg !609
  unreachable, !dbg !609
...
L643:                                             ; preds = %pass100
  ...
  br i1 %.not454.not.not, label %L648.L653_crit_edge, label %L652, !dbg !433

L648.L653_crit_edge:                              ; preds = %L643
  store i64 %.fr785, ptr %"new::Tuple67", align 1, !dbg !447, !tbaa !277, !alias.scope !279, !noalias !280
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(96) %.sroa.0.sroa.0, ptr noundef nonnull align 8 dereferenceable(96) %"new::SubContext.sroa.0.sroa.0", i64 96, i1 false), !dbg !238
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0.sroa.11, ptr noundef nonnull align 8 dereferenceable(32) %"new::NamedTuple.sroa.0.sroa.5", i64 32, i1 false), !dbg !238
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(64) %.sroa.0.sroa.12, ptr noundef nonnull align 8 dereferenceable(64) %"new::NamedTuple.sroa.0.sroa.5.144.sroa_idx", i64 64, i1 false), !dbg !238
...
L662:                                             ; preds = %L648.L653_crit_edge, %L642, %L34.L653_crit_edge
  %.sroa.0.sroa.8.0 = phi i64 [ %.sroa.0.sroa.8.0.copyload, %L34.L653_crit_edge ], [ %78, %L648.L653_crit_edge ], [ %78, %L642 ], !dbg !238
  %.sroa.0.sroa.9.0 = phi i64 [ %.sroa.0.sroa.9.0.copyload, %L34.L653_crit_edge ], [ %79, %L648.L653_crit_edge ], [ %79, %L642 ], !dbg !238
  %.sroa.0.sroa.10.0 = phi i64 [ %.sroa.0.sroa.10.0.copyload, %L34.L653_crit_edge ], [ %.sroa.0433.sroa.10.0.copyload662, %L648.L653_crit_edge ], [ %.sroa.0433.sroa.10.0.copyload662, %L642 ], !dbg !238
  %.sroa.0.sroa.14.0 = phi i64 [ %.sroa.0.sroa.14.0.copyload, %L34.L653_crit_edge ], [ %80, %L648.L653_crit_edge ], [ %80, %L642 ], !dbg !238
  %.sroa.0.sroa.15.0 = phi i64 [ %.sroa.0.sroa.15.0.copyload, %L34.L653_crit_edge ], [ %81, %L648.L653_crit_edge ], [ %81, %L642 ], !dbg !238
  %.sroa.0.sroa.16.0 = phi i64 [ %.sroa.0.sroa.16.0.copyload, %L34.L653_crit_edge ], [ %82, %L648.L653_crit_edge ], [ %82, %L642 ], !dbg !238
  %.sroa.0.sroa.17.0 = phi i64 [ %.sroa.0.sroa.17.0.copyload, %L34.L653_crit_edge ], [ %75, %L648.L653_crit_edge ], [ %75, %L642 ], !dbg !238
  %.sroa.0.sroa.18.sroa.0.0 = phi i64 [ %.sroa.0.sroa.18.sroa.0.0.copyload, %L34.L653_crit_edge ], [ undef, %L648.L653_crit_edge ], [ undef, %L642 ], !dbg !238
  %.sroa.0.sroa.18.sroa.8.0 = phi i64 [ %.sroa.0.sroa.18.sroa.8.0.copyload, %L34.L653_crit_edge ], [ %.fr785, %L648.L653_crit_edge ], [ %.fr785, %L642 ], !dbg !238
  %.sroa.0.sroa.18.sroa.10.0 = phi float [ %.sroa.0.sroa.18.sroa.10.0.copyload, %L34.L653_crit_edge ], [ %100, %L648.L653_crit_edge ], [ %100, %L642 ], !dbg !238
  %.sroa.0.sroa.18.sroa.12.0 = phi float [ %.sroa.0.sroa.18.sroa.12.0.copyload, %L34.L653_crit_edge ], [ %.sroa.7643.0, %L648.L653_crit_edge ], [ %.sroa.7643.0, %L642 ], !dbg !238
  %.sroa.0.sroa.18.sroa.14.0 = phi i64 [ %.sroa.0.sroa.18.sroa.14.0.copyload, %L34.L653_crit_edge ], [ 1, %L648.L653_crit_edge ], [ 1, %L642 ], !dbg !238
  %.sroa.0.sroa.18.sroa.16.0 = phi i8 [ %.sroa.0.sroa.18.sroa.16.0.copyload, %L34.L653_crit_edge ], [ %.sroa.9.0, %L648.L653_crit_edge ], [ %.sroa.9.0, %L642 ], !dbg !238
  %.sroa.8.0 = phi float [ %.sroa.8.0.copyload393, %L34.L653_crit_edge ], [ %156, %L648.L653_crit_edge ], [ %156, %L642 ], !dbg !238
  %.sroa.10.0 = phi i32 [ %.sroa.10.0.copyload394, %L34.L653_crit_edge ], [ %.sroa.7436.0.copyload437, %L648.L653_crit_edge ], [ %.sroa.7436.0.copyload437, %L642 ], !dbg !238
  %199 = call i64 @jlplt_ijl_hrtime_9538_got.jit(), !dbg !611
  ...
  %exactly_isa.not.not = icmp eq ptr %201, @"+Core.Nothing#9548.jit", !dbg !619
  ...
  br i1 %.not458, label %L717, label %L699, !dbg !622
...
L699:                                             ; preds = %L662
  ...
  %"box::ProcessContext" = call noalias nonnull align 8 dereferenceable(400) ptr @ijl_gc_small_alloc(ptr %ptls_load969, i32 1120, i32 400, i64 13114782928) #23, !dbg !624
  %"box::ProcessContext.tag_addr" = getelementptr inbounds i64, ptr %"box::ProcessContext", i64 -1, !dbg !624
  store atomic i64 13114782928, ptr %"box::ProcessContext.tag_addr" unordered, align 8, !dbg !624, !tbaa !281
...
327:                                              ; preds = %may_trigger_wb975, %trigger_wb1114, %L717
...
pass100:                                          ; preds = %guard_pass377, %guard_pass372
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(88) %"new::SubContext.sroa.0.sroa.0.8.sroa_idx", ptr noundef nonnull align 8 dereferenceable(88) %"new::NamedTuple.sroa.0.sroa.0", i64 88, i1 false), !dbg !652, !tbaa !277, !alias.scope !279, !noalias !280
  ...
  br i1 %"process::Process.shouldrun.not.not.not.not", label %L642, label %L643, !dbg !678
...
guard_pass362:                                    ; preds = %L131
  ...
  %360 = trunc i64 %unionalloca.sroa.0.0.unionalloca.sroa.0.0.unionalloca.sroa.0.0.unionalloca.sroa.0.0.copyload461786 to i32, !dbg !679
...
guard_pass372:                                    ; preds = %L552
  ...
  store float %.sroa.7643.0, ptr %memoryref_data97, align 4, !dbg !689, !tbaa !322, !alias.scope !190, !noalias !191
