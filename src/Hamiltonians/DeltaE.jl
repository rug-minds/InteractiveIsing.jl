...
"""
@generated function dEIsing(g, gstate, gadj::SparseMatrixCSC, idx, stype::SType)::Float32
...
function dEIsing(g, gstate, gadj::Vector{Vector{Tuple{Int32, Float32}}}, idx, stype::SType)
    efac = 0f0
    conns = gadj[idx]
