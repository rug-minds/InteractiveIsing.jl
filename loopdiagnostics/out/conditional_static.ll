; Function Signature: conditional_capture_static(Int64, Base.Val{20}, Float64, Float64)
; Function Attrs: uwtable
define swiftcc double @julia_conditional_capture_static_674(ptr nonnull swiftself %pgcstack, i64 signext %"n::Int64", double %"x::Float64", double %"bias::Float64") #0 !dbg !4 {
top:
