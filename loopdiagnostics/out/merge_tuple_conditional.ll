; Function Signature: merge_tuple_conditional(Int64, Base.Val{20}, Float64, Float64)
; Function Attrs: uwtable
define swiftcc double @julia_merge_tuple_conditional_794(ptr nonnull swiftself %pgcstack, i64 signext %"n::Int64", double %"x::Float64", double %"bias::Float64") #0 !dbg !4 {
top:
