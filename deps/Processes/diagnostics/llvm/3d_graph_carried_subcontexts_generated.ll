...
top:
  ...
  %.sroa.10655 = alloca [7 x i8], align 1
  ...
  %.sroa.0420.sroa.0 = alloca [12 x i64], align 8
  %.sroa.0420.sroa.9 = alloca [4 x i64], align 8
  %.sroa.0420.sroa.10 = alloca [8 x i64], align 8
  %.sroa.0420.sroa.11 = alloca [4 x i64], align 8
  %.sroa.0420.sroa.16.sroa.16 = alloca [7 x i8], align 1
  %.sroa.8425 = alloca [7 x i64], align 8
  ...
  fence syncscope("singlethread") seq_cst
  store i8 1, ptr @"jl_global#9621.jit", align 16, !dbg !172, !tbaa !187, !alias.scope !190, !noalias !191
  ...
  %66 = call i64 @jlplt_ijl_hrtime_9623_got.jit(), !dbg !206
  ...
  br i1 %.not.not, label %L33.L654_crit_edge, label %L33.L37_crit_edge, !dbg !231

L33.L654_crit_edge:                               ; preds = %top
  ...
  br label %L663, !dbg !238

L33.L37_crit_edge:                                ; preds = %top
  %".sroa.0432.sroa.8.0.context::ProcessContext.sroa_idx" = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 96, !dbg !238
  %".sroa.0432.sroa.10.0.context::ProcessContext.sroa_idx" = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 112, !dbg !238
  %.sroa.0432.sroa.10.0.copyload668 = load i64, ptr %".sroa.0432.sroa.10.0.context::ProcessContext.sroa_idx", align 8, !dbg !238, !tbaa !240, !alias.scope !241, !noalias !242
  %".sroa.0432.sroa.11.0.context::ProcessContext.sroa_idx" = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 120, !dbg !238
  %".sroa.0432.sroa.12.0.context::ProcessContext.sroa_idx" = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 152, !dbg !238
  %".sroa.0432.sroa.13.0.context::ProcessContext.sroa_idx" = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 216, !dbg !238
  %".sroa.0432.sroa.14.0.context::ProcessContext.sroa_idx" = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 248, !dbg !238
  %".sroa.0432.sroa.16.0.context::ProcessContext.sroa_idx" = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 264, !dbg !238
  %".sroa.0432.sroa.18.0.context::ProcessContext.sroa_idx" = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 280, !dbg !238
  %".sroa.0432.sroa.20.0.context::ProcessContext.sroa_idx" = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 296, !dbg !238
  %".sroa.0432.sroa.22.0.context::ProcessContext.sroa_idx" = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 304, !dbg !238
  %.sroa.0432.sroa.22.0.copyload698 = load i64, ptr %".sroa.0432.sroa.22.0.context::ProcessContext.sroa_idx", align 8, !dbg !238, !tbaa !240, !alias.scope !241, !noalias !242
  %".sroa.0432.sroa.23.0.context::ProcessContext.sroa_idx" = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 312, !dbg !238
  %.sroa.0432.sroa.23.0.copyload701 = load i8, ptr %".sroa.0432.sroa.23.0.context::ProcessContext.sroa_idx", align 8, !dbg !238, !tbaa !240, !alias.scope !241, !noalias !242
  %".sroa.0432.sroa.24.0.context::ProcessContext.sroa_idx" = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 313, !dbg !238
  %".sroa.6433.0.context::ProcessContext.sroa_idx" = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 320, !dbg !238
  %.sroa.6433.0.copyload434 = load float, ptr %".sroa.6433.0.context::ProcessContext.sroa_idx", align 8, !dbg !238, !tbaa !240, !alias.scope !241, !noalias !242
  %".sroa.7435.0.context::ProcessContext.sroa_idx" = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 324, !dbg !238
  %.sroa.7435.0.copyload436 = load i32, ptr %".sroa.7435.0.context::ProcessContext.sroa_idx", align 4, !dbg !238, !tbaa !240, !alias.scope !241, !noalias !242
  ...
  %.sroa.0432.sroa.8.0..sroa_idx663 = getelementptr inbounds i8, ptr %2, i64 96, !dbg !231
  %.sroa.0432.sroa.9.0..sroa_idx666 = getelementptr inbounds i8, ptr %2, i64 104, !dbg !231
  %69 = load <2 x i64>, ptr %".sroa.0432.sroa.8.0.context::ProcessContext.sroa_idx", align 8, !dbg !238, !tbaa !240, !alias.scope !241, !noalias !242
  store <2 x i64> %69, ptr %.sroa.0432.sroa.8.0..sroa_idx663, align 8, !dbg !231
  %.sroa.0432.sroa.10.0..sroa_idx669 = getelementptr inbounds i8, ptr %2, i64 112, !dbg !231
  store i64 %.sroa.0432.sroa.10.0.copyload668, ptr %.sroa.0432.sroa.10.0..sroa_idx669, align 8, !dbg !231
  %.sroa.0432.sroa.11.0..sroa_idx671 = getelementptr inbounds i8, ptr %2, i64 120, !dbg !231
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0432.sroa.11.0..sroa_idx671, ptr noundef nonnull align 8 dereferenceable(32) %".sroa.0432.sroa.11.0.context::ProcessContext.sroa_idx", i64 32, i1 false), !dbg !231
  %.sroa.0432.sroa.12.0..sroa_idx672 = getelementptr inbounds i8, ptr %2, i64 152, !dbg !231
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(64) %.sroa.0432.sroa.12.0..sroa_idx672, ptr noundef nonnull align 8 dereferenceable(64) %".sroa.0432.sroa.12.0.context::ProcessContext.sroa_idx", i64 64, i1 false), !dbg !231
  %.sroa.0432.sroa.13.0..sroa_idx673 = getelementptr inbounds i8, ptr %2, i64 216, !dbg !231
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0432.sroa.13.0..sroa_idx673, ptr noundef nonnull align 8 dereferenceable(32) %".sroa.0432.sroa.13.0.context::ProcessContext.sroa_idx", i64 32, i1 false), !dbg !231
  %.sroa.0432.sroa.14.0..sroa_idx675 = getelementptr inbounds i8, ptr %2, i64 248, !dbg !231
  %.sroa.0432.sroa.15.0..sroa_idx678 = getelementptr inbounds i8, ptr %2, i64 256, !dbg !231
  %70 = load <2 x i64>, ptr %".sroa.0432.sroa.14.0.context::ProcessContext.sroa_idx", align 8, !dbg !238, !tbaa !240, !alias.scope !241, !noalias !242
  store <2 x i64> %70, ptr %.sroa.0432.sroa.14.0..sroa_idx675, align 8, !dbg !231
  %.sroa.0432.sroa.16.0..sroa_idx681 = getelementptr inbounds i8, ptr %2, i64 264, !dbg !231
  %.sroa.0432.sroa.17.0..sroa_idx684 = getelementptr inbounds i8, ptr %2, i64 272, !dbg !231
  %71 = load <2 x i64>, ptr %".sroa.0432.sroa.16.0.context::ProcessContext.sroa_idx", align 8, !dbg !238, !tbaa !240, !alias.scope !241, !noalias !242
  store <2 x i64> %71, ptr %.sroa.0432.sroa.16.0..sroa_idx681, align 8, !dbg !231
  %.sroa.0432.sroa.18.0..sroa_idx687 = getelementptr inbounds i8, ptr %2, i64 280, !dbg !231
  %.sroa.0432.sroa.19.0..sroa_idx690 = getelementptr inbounds i8, ptr %2, i64 288, !dbg !231
  %72 = load <2 x i64>, ptr %".sroa.0432.sroa.18.0.context::ProcessContext.sroa_idx", align 8, !dbg !238, !tbaa !240, !alias.scope !241, !noalias !242
  store <2 x i64> %72, ptr %.sroa.0432.sroa.18.0..sroa_idx687, align 8, !dbg !231
  %.sroa.0432.sroa.20.0..sroa_idx693 = getelementptr inbounds i8, ptr %2, i64 296, !dbg !231
  %.sroa.0432.sroa.21.0..sroa_idx696 = getelementptr inbounds i8, ptr %2, i64 300, !dbg !231
  %73 = load <2 x float>, ptr %".sroa.0432.sroa.20.0.context::ProcessContext.sroa_idx", align 8, !dbg !238, !tbaa !240, !alias.scope !241, !noalias !242
  store <2 x float> %73, ptr %.sroa.0432.sroa.20.0..sroa_idx693, align 8, !dbg !231
  %.sroa.0432.sroa.22.0..sroa_idx699 = getelementptr inbounds i8, ptr %2, i64 304, !dbg !231
  store i64 %.sroa.0432.sroa.22.0.copyload698, ptr %.sroa.0432.sroa.22.0..sroa_idx699, align 8, !dbg !231
  %.sroa.0432.sroa.23.0..sroa_idx702 = getelementptr inbounds i8, ptr %2, i64 312, !dbg !231
  store i8 %.sroa.0432.sroa.23.0.copyload701, ptr %.sroa.0432.sroa.23.0..sroa_idx702, align 8, !dbg !231
  %.sroa.0432.sroa.24.0..sroa_idx704 = getelementptr inbounds i8, ptr %2, i64 313, !dbg !231
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %.sroa.0432.sroa.24.0..sroa_idx704, ptr noundef nonnull align 1 dereferenceable(7) %".sroa.0432.sroa.24.0.context::ProcessContext.sroa_idx", i64 7, i1 false), !dbg !231
  %.sroa.6433.0..sroa_idx = getelementptr inbounds i8, ptr %2, i64 320, !dbg !231
  store float %.sroa.6433.0.copyload434, ptr %.sroa.6433.0..sroa_idx, align 8, !dbg !231
  %.sroa.7435.0..sroa_idx = getelementptr inbounds i8, ptr %2, i64 324, !dbg !231
  store i32 %.sroa.7435.0.copyload436, ptr %.sroa.7435.0..sroa_idx, align 4, !dbg !231
  %74 = getelementptr inbounds i8, ptr %2, i64 136, !dbg !243
  %.stop_ptr = getelementptr inbounds i8, ptr %2, i64 144, !dbg !251
  %.stop_ptr.unbox522 = load i64, ptr %.stop_ptr, align 8, !dbg !275, !tbaa !277, !alias.scope !279, !noalias !280
  %.unbox523 = load i64, ptr %74, align 8, !dbg !275, !tbaa !277, !alias.scope !279, !noalias !280
  %.not524 = icmp slt i64 %.stop_ptr.unbox522, %.unbox523, !dbg !275
  ...
  br i1 %.not524, label %L56, label %L59.lr.ph, !dbg !255

L59.lr.ph:                                        ; preds = %L33.L37_crit_edge
...
L56:                                              ; preds = %L653, %L33.L37_crit_edge
  %92 = call swiftcc [1 x ptr] @j_ArgumentError_9624(ptr nonnull swiftself %pgcstack, ptr nonnull @"jl_global#9625.jit"), !dbg !255
  ...
  %ptls_load962 = load ptr, ptr %ptls_field, align 8, !dbg !255, !tbaa !157
  %"box::ArgumentError" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load962, i32 424, i32 16, i64 4839131120) #23, !dbg !255
  %"box::ArgumentError.tag_addr" = getelementptr inbounds i64, ptr %"box::ArgumentError", i64 -1, !dbg !255
  store atomic i64 4839131120, ptr %"box::ArgumentError.tag_addr" unordered, align 8, !dbg !255, !tbaa !281
...
L59:                                              ; preds = %L653, %L59.lr.ph
  %94 = phi i64 [ %"new::Tuple67.promoted", %L59.lr.ph ], [ %.fr791, %L653 ]
  %.unbox527 = phi i64 [ %.unbox523, %L59.lr.ph ], [ %.unbox, %L653 ]
  %.stop_ptr.unbox526 = phi i64 [ %.stop_ptr.unbox522, %L59.lr.ph ], [ %.stop_ptr.unbox, %L653 ]
  %value_phi5525 = phi i64 [ %"process::Process.loopidx", %L59.lr.ph ], [ %198, %L653 ]
  %.unbox66 = bitcast i32 %83 to float, !dbg !255
  %.unbox274 = bitcast i32 %.sroa.7435.0.copyload436 to float, !dbg !255
  %95 = add i64 %.stop_ptr.unbox526, 1, !dbg !285
  %96 = sub i64 %95, %.unbox527, !dbg !288
  store i64 %.unbox527, ptr %"new::SamplerRangeNDL", align 8, !dbg !289, !tbaa !277, !alias.scope !279, !noalias !280
  store i64 %96, ptr %84, align 8, !dbg !289, !tbaa !277, !alias.scope !279, !noalias !280
  %97 = call swiftcc i64 @j_rand_9627(ptr nonnull swiftself %pgcstack, ptr %47, ptr nocapture nonnull readonly %"new::SamplerRangeNDL"), !dbg !263
  %.fr791 = freeze i64 %97
  ...
  %.not437 = icmp eq i64 %root_phi25.state.size.0.copyload, 100000, !dbg !306
  br i1 %.not437, label %L85, label %L80, !dbg !301

L80:                                              ; preds = %L59
  call swiftcc void @j_throw_dmrsa_9628(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %root_phi25.state.size.0.copyload) #9, !dbg !311
  unreachable, !dbg !311

L85:                                              ; preds = %L59
  %98 = load ptr, ptr %root_phi25.state, align 8, !dbg !312, !tbaa !314, !alias.scope !317, !noalias !318
  %memoryref_offset = shl i64 %.fr791, 2, !dbg !319
...
L136:                                             ; preds = %L131
  ...
  %.not442 = icmp eq i64 %root_phi26.idxF295, 1002, !dbg !365
  br i1 %.not442, label %L139, label %L141, !dbg !350

L139:                                             ; preds = %L136
  %104 = call swiftcc i64 @j_gen_rand_9635(ptr nonnull swiftself %pgcstack, ptr %47), !dbg !350
...
L197:                                             ; preds = %L141
  %122 = call swiftcc double @j_rem_internal_9639(ptr nonnull swiftself %pgcstack, double %121, double 4.000000e+00), !dbg !428
...
L201:                                             ; preds = %L141
  ...
  %.not443 = icmp eq i64 %124, 9218868437227405312, !dbg !434
  br i1 %.not443, label %L216, label %L209, !dbg !436
...
L216:                                             ; preds = %L209, %L201
  %value_phi313459 = phi double [ %value_phi313, %L209 ], [ 0x7FF8000000000000, %L201 ]
  %127 = fcmp ogt double %value_phi313459, 0.000000e+00, !dbg !442
  %128 = fadd double %value_phi313459, 4.000000e+00
  %spec.select384 = select i1 %127, double %value_phi313459, double %128, !dbg !446
...
L244:                                             ; preds = %L85
  ...
  %ptls_load967 = load ptr, ptr %ptls_field, align 8, !dbg !462, !tbaa !157
  %"box::Float64" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load967, i32 424, i32 16, i64 4839710864) #23, !dbg !462
  %"box::Float64.tag_addr" = getelementptr inbounds i64, ptr %"box::Float64", i64 -1, !dbg !462
  store atomic i64 4839710864, ptr %"box::Float64.tag_addr" unordered, align 8, !dbg !462, !tbaa !281
  store i64 %75, ptr %"box::Float64", align 8, !dbg !462, !tbaa !240, !alias.scope !467, !noalias !468
  %gc_slot_addr_7952 = getelementptr inbounds ptr, ptr %gcframe2, i64 9
  store ptr %"box::Float64", ptr %gc_slot_addr_7952, align 8
  store ptr @"jl_global#9640.jit", ptr %jlcallframe1, align 8, !dbg !462
...
L262:                                             ; preds = %guard_pass367, %guard_pass362
  %.sroa.7649.0 = phi float [ %361, %guard_pass362 ], [ %366, %guard_pass367 ], !dbg !238
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %.sroa.11, ptr noundef nonnull align 1 dereferenceable(7) %.sroa.10655, i64 7, i1 false), !dbg !469
  call void @llvm.lifetime.end.p0(i64 7, ptr nonnull %.sroa.10655), !dbg !469
  ...
  store i64 %.fr791, ptr %85, align 8, !dbg !459, !tbaa !277, !alias.scope !279, !noalias !280
  ...
  store float %.sroa.7649.0, ptr %"new::Tuple.sroa.0.sroa.3.0..sroa_idx", align 4, !dbg !459, !tbaa !277, !alias.scope !279, !noalias !280
  ...
  %133 = add i64 %.fr791, -1, !dbg !470
  %root_phi7.size.0.copyload = load i64, ptr %root_phi7.size_ptr, align 8, !dbg !474, !tbaa !240, !alias.scope !304, !noalias !305
  %.not444 = icmp ult i64 %133, %root_phi7.size.0.copyload, !dbg !470
  br i1 %.not444, label %L320, label %L317, !dbg !470

L317:                                             ; preds = %L262
  store i64 %.fr791, ptr %"new::Tuple290", align 8, !dbg !470, !tbaa !277, !alias.scope !279, !noalias !280
  call swiftcc void @j_throw_boundserror_9637(ptr nonnull swiftself %pgcstack, ptr %9, ptr nocapture nonnull readonly %"new::Tuple290") #9, !dbg !470
  unreachable, !dbg !470
...
L320:                                             ; preds = %L262
  ...
  %136 = fpext float %.sroa.7649.0 to double, !dbg !480
  %gc_slot_addr_7953 = getelementptr inbounds ptr, ptr %gcframe2, i64 9
  store ptr %root_phi6.state, ptr %gc_slot_addr_7953, align 8
  %137 = call swiftcc double @"j_#power_by_squaring#401_9631"(ptr nonnull swiftself %pgcstack, double %136, i64 signext 2), !dbg !487
  ...
  %.not445 = icmp ult i64 %133, %root_phi6.state.size.0.copyload, !dbg !470
  br i1 %.not445, label %L345, label %L342, !dbg !470

L342:                                             ; preds = %L320
  store i64 %.fr791, ptr %"new::Tuple288", align 8, !dbg !470, !tbaa !277, !alias.scope !279, !noalias !280
  store ptr %root_phi6.state, ptr %gc_slot_addr_7953, align 8
  call swiftcc void @j_throw_boundserror_9637(ptr nonnull swiftself %pgcstack, ptr nonnull %root_phi6.state, ptr nocapture nonnull readonly %"new::Tuple288") #9, !dbg !470
  unreachable, !dbg !470
...
L345:                                             ; preds = %L320
  ...
  store ptr null, ptr %gc_slot_addr_7953, align 8
  %142 = call swiftcc double @"j_#power_by_squaring#401_9631"(ptr nonnull swiftself %pgcstack, double %141, i64 signext 2), !dbg !487
  ...
  %148 = call swiftcc float @"j_#calculate##0_9632"(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %"new::#calculate##0#calculate##1", ptr nocapture nonnull readonly %0, float %147, ptr nocapture nonnull readonly %86, ptr nocapture nonnull readonly %1), !dbg !456
  %149 = fneg float %.unbox66, !dbg !500
  %.not446 = icmp ult i64 %133, %.sroa.0432.sroa.10.0.copyload668, !dbg !501
  br i1 %.not446, label %L403, label %L400, !dbg !507

L400:                                             ; preds = %L345
  %150 = getelementptr inbounds ptr, ptr %gcframe2, i64 8
  store i64 %.fr791, ptr %"new::Tuple67", align 1, !dbg !447, !tbaa !277, !alias.scope !279, !noalias !280
  store ptr %25, ptr %150, align 8, !dbg !507
  call swiftcc void @j_throw_boundserror_9638(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %.sroa.0432.sroa.9.0..sroa_idx666, ptr nocapture nonnull readonly %150, ptr nocapture nonnull readonly %"new::Tuple67") #9, !dbg !507
  unreachable, !dbg !507
...
L403:                                             ; preds = %L345
  ...
  %.not447 = icmp ult i64 %133, %root_phi6.state65.size.0.copyload, !dbg !511
  br i1 %.not447, label %L420, label %L417, !dbg !511

L417:                                             ; preds = %L403
  store i64 %.fr791, ptr %"new::Tuple285", align 8, !dbg !511, !tbaa !277, !alias.scope !279, !noalias !280
  store ptr %root_phi6.state65, ptr %gc_slot_addr_7953, align 8
  call swiftcc void @j_throw_boundserror_9637(ptr nonnull swiftself %pgcstack, ptr nonnull %root_phi6.state65, ptr nocapture nonnull readonly %"new::Tuple285") #9, !dbg !511
  unreachable, !dbg !511
...
L420:                                             ; preds = %L403
  ...
  %153 = fsub float %.sroa.7649.0, %152, !dbg !517
...
L435:                                             ; preds = %L420
  ...
  %.not448 = icmp eq i64 %root_phi26.idxF, 1002, !dbg !536
  br i1 %.not448, label %L438, label %L440, !dbg !525

L438:                                             ; preds = %L435
  %158 = call swiftcc i64 @j_gen_rand_9635(ptr nonnull swiftself %pgcstack, ptr %47), !dbg !525
...
L552:                                             ; preds = %L550, %L420
  ...
  %.not450 = icmp eq i64 %root_phi25.state80.size.0.copyload, 100000, !dbg !607
  br i1 %.not450, label %guard_pass372, label %L560, !dbg !606

L560:                                             ; preds = %L552
  call swiftcc void @j_throw_dmrsa_9628(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %root_phi25.state80.size.0.copyload) #9, !dbg !609
  unreachable, !dbg !609
...
L643:                                             ; preds = %pass100
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %.sroa.0.sroa.18.sroa.18, ptr noundef nonnull align 1 dereferenceable(7) %.sroa.6608, i64 7, i1 false), !dbg !238
  br label %L663, !dbg !238

L644:                                             ; preds = %pass100
  %.not453.not.not = icmp eq i64 %value_phi5525, %value_phi, !dbg !610
  br i1 %.not453.not.not, label %L649.L654_crit_edge, label %L653, !dbg !433

L649.L654_crit_edge:                              ; preds = %L644
  store i64 %.fr791, ptr %"new::Tuple67", align 1, !dbg !447, !tbaa !277, !alias.scope !279, !noalias !280
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(96) %.sroa.0.sroa.0, ptr noundef nonnull align 8 dereferenceable(96) %"new::SubContext.sroa.0.sroa.0", i64 96, i1 false), !dbg !238
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0.sroa.11, ptr noundef nonnull align 8 dereferenceable(32) %"new::NamedTuple.sroa.0.sroa.5", i64 32, i1 false), !dbg !238
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(64) %.sroa.0.sroa.12, ptr noundef nonnull align 8 dereferenceable(64) %"new::NamedTuple.sroa.0.sroa.5.144.sroa_idx", i64 64, i1 false), !dbg !238
...
L653:                                             ; preds = %L644
  %198 = add i64 %value_phi5525, 1, !dbg !432
  ...
  store i64 %78, ptr %.sroa.0432.sroa.8.0..sroa_idx663, align 8, !dbg !231
  store i64 %79, ptr %.sroa.0432.sroa.9.0..sroa_idx666, align 8, !dbg !231
  store i64 %.sroa.0432.sroa.10.0.copyload668, ptr %.sroa.0432.sroa.10.0..sroa_idx669, align 8, !dbg !231
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0432.sroa.11.0..sroa_idx671, ptr noundef nonnull align 8 dereferenceable(32) %"new::NamedTuple.sroa.0.sroa.5", i64 32, i1 false), !dbg !231
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(64) %.sroa.0432.sroa.12.0..sroa_idx672, ptr noundef nonnull align 8 dereferenceable(64) %"new::NamedTuple.sroa.0.sroa.5.144.sroa_idx", i64 64, i1 false), !dbg !231
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0432.sroa.13.0..sroa_idx673, ptr noundef nonnull align 8 dereferenceable(32) %"new::NamedTuple.sroa.0.sroa.5.208.sroa_idx", i64 32, i1 false), !dbg !231
  store i64 %80, ptr %.sroa.0432.sroa.14.0..sroa_idx675, align 8, !dbg !231
  store i64 %81, ptr %.sroa.0432.sroa.15.0..sroa_idx678, align 8, !dbg !231
  store i64 %82, ptr %.sroa.0432.sroa.16.0..sroa_idx681, align 8, !dbg !231
  store i64 %75, ptr %.sroa.0432.sroa.17.0..sroa_idx684, align 8, !dbg !231
  store i64 %.fr791, ptr %.sroa.0432.sroa.19.0..sroa_idx690, align 8, !dbg !231
  store float %100, ptr %.sroa.0432.sroa.20.0..sroa_idx693, align 8, !dbg !231
  store float %.sroa.7649.0, ptr %.sroa.0432.sroa.21.0..sroa_idx696, align 4, !dbg !231
  store i64 1, ptr %.sroa.0432.sroa.22.0..sroa_idx699, align 8, !dbg !231
  store i8 %.sroa.9.0, ptr %.sroa.0432.sroa.23.0..sroa_idx702, align 8, !dbg !231
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %.sroa.0432.sroa.24.0..sroa_idx704, ptr noundef nonnull align 1 dereferenceable(7) %.sroa.6608, i64 7, i1 false), !dbg !231
  store float %156, ptr %.sroa.6433.0..sroa_idx, align 8, !dbg !231
  store i32 %.sroa.7435.0.copyload436, ptr %.sroa.7435.0..sroa_idx, align 4, !dbg !231
...
L663:                                             ; preds = %L649.L654_crit_edge, %L643, %L33.L654_crit_edge
  %.sroa.0.sroa.8.0 = phi i64 [ %.sroa.0.sroa.8.0.copyload, %L33.L654_crit_edge ], [ %78, %L649.L654_crit_edge ], [ %78, %L643 ], !dbg !238
  %.sroa.0.sroa.9.0 = phi i64 [ %.sroa.0.sroa.9.0.copyload, %L33.L654_crit_edge ], [ %79, %L649.L654_crit_edge ], [ %79, %L643 ], !dbg !238
  %.sroa.0.sroa.10.0 = phi i64 [ %.sroa.0.sroa.10.0.copyload, %L33.L654_crit_edge ], [ %.sroa.0432.sroa.10.0.copyload668, %L649.L654_crit_edge ], [ %.sroa.0432.sroa.10.0.copyload668, %L643 ], !dbg !238
  %.sroa.0.sroa.14.0 = phi i64 [ %.sroa.0.sroa.14.0.copyload, %L33.L654_crit_edge ], [ %80, %L649.L654_crit_edge ], [ %80, %L643 ], !dbg !238
  %.sroa.0.sroa.15.0 = phi i64 [ %.sroa.0.sroa.15.0.copyload, %L33.L654_crit_edge ], [ %81, %L649.L654_crit_edge ], [ %81, %L643 ], !dbg !238
  %.sroa.0.sroa.16.0 = phi i64 [ %.sroa.0.sroa.16.0.copyload, %L33.L654_crit_edge ], [ %82, %L649.L654_crit_edge ], [ %82, %L643 ], !dbg !238
  %.sroa.0.sroa.17.0 = phi i64 [ %.sroa.0.sroa.17.0.copyload, %L33.L654_crit_edge ], [ %75, %L649.L654_crit_edge ], [ %75, %L643 ], !dbg !238
  %.sroa.0.sroa.18.sroa.0.0 = phi i64 [ %.sroa.0.sroa.18.sroa.0.0.copyload, %L33.L654_crit_edge ], [ undef, %L649.L654_crit_edge ], [ undef, %L643 ], !dbg !238
  %.sroa.0.sroa.18.sroa.8.0 = phi i64 [ %.sroa.0.sroa.18.sroa.8.0.copyload, %L33.L654_crit_edge ], [ %.fr791, %L649.L654_crit_edge ], [ %.fr791, %L643 ], !dbg !238
  %.sroa.0.sroa.18.sroa.10.0 = phi float [ %.sroa.0.sroa.18.sroa.10.0.copyload, %L33.L654_crit_edge ], [ %100, %L649.L654_crit_edge ], [ %100, %L643 ], !dbg !238
  %.sroa.0.sroa.18.sroa.12.0 = phi float [ %.sroa.0.sroa.18.sroa.12.0.copyload, %L33.L654_crit_edge ], [ %.sroa.7649.0, %L649.L654_crit_edge ], [ %.sroa.7649.0, %L643 ], !dbg !238
  %.sroa.0.sroa.18.sroa.14.0 = phi i64 [ %.sroa.0.sroa.18.sroa.14.0.copyload, %L33.L654_crit_edge ], [ 1, %L649.L654_crit_edge ], [ 1, %L643 ], !dbg !238
  %.sroa.0.sroa.18.sroa.16.0 = phi i8 [ %.sroa.0.sroa.18.sroa.16.0.copyload, %L33.L654_crit_edge ], [ %.sroa.9.0, %L649.L654_crit_edge ], [ %.sroa.9.0, %L643 ], !dbg !238
  %.sroa.8.0 = phi float [ %.sroa.8.0.copyload393, %L33.L654_crit_edge ], [ %156, %L649.L654_crit_edge ], [ %156, %L643 ], !dbg !238
  %.sroa.10.0 = phi i32 [ %.sroa.10.0.copyload394, %L33.L654_crit_edge ], [ %.sroa.7435.0.copyload436, %L649.L654_crit_edge ], [ %.sroa.7435.0.copyload436, %L643 ], !dbg !238
  %199 = call i64 @jlplt_ijl_hrtime_9623_got.jit(), !dbg !611
  ...
  %exactly_isa.not.not = icmp eq ptr %201, @"+Core.Nothing#9633.jit", !dbg !619
  ...
  %.not457 = select i1 %exactly_isa.not.not, i1 true, i1 %204, !dbg !622
  br i1 %.not457, label %L717, label %L699, !dbg !622

L699:                                             ; preds = %L663
  %"process::Process.runtime_context_ptr" = getelementptr inbounds i8, ptr %"process::Process", i64 448, !dbg !624
  %ptls_load975 = load ptr, ptr %ptls_field, align 8, !dbg !624, !tbaa !157
  %"box::ProcessContext" = call noalias nonnull align 8 dereferenceable(400) ptr @ijl_gc_small_alloc(ptr %ptls_load975, i32 1120, i32 400, i64 15386681040) #23, !dbg !624
  %"box::ProcessContext.tag_addr" = getelementptr inbounds i64, ptr %"box::ProcessContext", i64 -1, !dbg !624
  store atomic i64 15386681040, ptr %"box::ProcessContext.tag_addr" unordered, align 8, !dbg !624, !tbaa !281
...
242:                                              ; preds = %may_trigger_wb, %trigger_wb, %L699
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(96) %.sroa.0420.sroa.0, ptr noundef nonnull align 8 dereferenceable(96) %.sroa.0.sroa.0, i64 96, i1 false), !dbg !238
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0420.sroa.9, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0.sroa.11, i64 32, i1 false), !dbg !238
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(64) %.sroa.0420.sroa.10, ptr noundef nonnull align 8 dereferenceable(64) %.sroa.0.sroa.12, i64 64, i1 false), !dbg !238
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0420.sroa.11, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0.sroa.13, i64 32, i1 false), !dbg !238
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %.sroa.0420.sroa.16.sroa.16, ptr noundef nonnull align 1 dereferenceable(7) %.sroa.0.sroa.18.sroa.18, i64 7, i1 false), !dbg !238
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %.sroa.8425, ptr noundef nonnull align 8 dereferenceable(56) %"new::ProcessContext.sroa.21", i64 56, i1 false), !dbg !238
  br label %L727, !dbg !238
...
L717:                                             ; preds = %L663
  ...
  %"process::Process.tag_addr977" = getelementptr inbounds i64, ptr %"process::Process", i64 -1, !dbg !637
  %"process::Process.tag978" = load atomic volatile i64, ptr %"process::Process.tag_addr977" unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %parent_bits979 = and i64 %"process::Process.tag978", 3, !dbg !637
  %parent_old_marked980 = icmp eq i64 %parent_bits979, 3, !dbg !637
  br i1 %parent_old_marked980, label %may_trigger_wb981, label %327, !dbg !637

may_trigger_wb981:                                ; preds = %L717
  ...
  %.tag_addr984 = getelementptr inbounds i64, ptr %245, i64 -1, !dbg !637
  %.tag985 = load atomic volatile i64, ptr %.tag_addr984 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %292 = and i64 %.tag, %.tag985, !dbg !637
  %.tag_addr988 = getelementptr inbounds i64, ptr %247, i64 -1, !dbg !637
  %.tag989 = load atomic volatile i64, ptr %.tag_addr988 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %293 = and i64 %292, %.tag989, !dbg !637
  %.tag_addr992 = getelementptr inbounds i64, ptr %249, i64 -1, !dbg !637
  %.tag993 = load atomic volatile i64, ptr %.tag_addr992 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %294 = and i64 %293, %.tag993, !dbg !637
  %.tag_addr996 = getelementptr inbounds i64, ptr %251, i64 -1, !dbg !637
  %.tag997 = load atomic volatile i64, ptr %.tag_addr996 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %295 = and i64 %294, %.tag997, !dbg !637
  %.tag_addr1000 = getelementptr inbounds i64, ptr %5, i64 -1, !dbg !637
  %.tag1001 = load atomic volatile i64, ptr %.tag_addr1000 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %296 = and i64 %295, %.tag1001, !dbg !637
  %.tag_addr1004 = getelementptr inbounds i64, ptr %7, i64 -1, !dbg !637
  %.tag1005 = load atomic volatile i64, ptr %.tag_addr1004 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %297 = and i64 %296, %.tag1005, !dbg !637
  %.tag_addr1008 = getelementptr inbounds i64, ptr %9, i64 -1, !dbg !637
  %.tag1009 = load atomic volatile i64, ptr %.tag_addr1008 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %298 = and i64 %297, %.tag1009, !dbg !637
  %.tag_addr1012 = getelementptr inbounds i64, ptr %11, i64 -1, !dbg !637
  %.tag1013 = load atomic volatile i64, ptr %.tag_addr1012 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %299 = and i64 %298, %.tag1013, !dbg !637
  %.tag_addr1016 = getelementptr inbounds i64, ptr %13, i64 -1, !dbg !637
  %.tag1017 = load atomic volatile i64, ptr %.tag_addr1016 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %300 = and i64 %299, %.tag1017, !dbg !637
  %.tag_addr1020 = getelementptr inbounds i64, ptr %15, i64 -1, !dbg !637
  %.tag1021 = load atomic volatile i64, ptr %.tag_addr1020 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %301 = and i64 %300, %.tag1021, !dbg !637
  %.tag_addr1024 = getelementptr inbounds i64, ptr %17, i64 -1, !dbg !637
  %.tag1025 = load atomic volatile i64, ptr %.tag_addr1024 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %302 = and i64 %301, %.tag1025, !dbg !637
  %.tag_addr1028 = getelementptr inbounds i64, ptr %19, i64 -1, !dbg !637
  %.tag1029 = load atomic volatile i64, ptr %.tag_addr1028 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %303 = and i64 %302, %.tag1029, !dbg !637
  %.tag_addr1032 = getelementptr inbounds i64, ptr %21, i64 -1, !dbg !637
  %.tag1033 = load atomic volatile i64, ptr %.tag_addr1032 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %304 = and i64 %303, %.tag1033, !dbg !637
  %.tag_addr1036 = getelementptr inbounds i64, ptr %23, i64 -1, !dbg !637
  %.tag1037 = load atomic volatile i64, ptr %.tag_addr1036 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %305 = and i64 %304, %.tag1037, !dbg !637
  %.tag_addr1040 = getelementptr inbounds i64, ptr %25, i64 -1, !dbg !637
  %.tag1041 = load atomic volatile i64, ptr %.tag_addr1040 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %306 = and i64 %305, %.tag1041, !dbg !637
  %.tag_addr1044 = getelementptr inbounds i64, ptr %27, i64 -1, !dbg !637
  %.tag1045 = load atomic volatile i64, ptr %.tag_addr1044 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %307 = and i64 %306, %.tag1045, !dbg !637
  %.tag_addr1048 = getelementptr inbounds i64, ptr %29, i64 -1, !dbg !637
  %.tag1049 = load atomic volatile i64, ptr %.tag_addr1048 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %308 = and i64 %307, %.tag1049, !dbg !637
  %.tag_addr1052 = getelementptr inbounds i64, ptr %31, i64 -1, !dbg !637
  %.tag1053 = load atomic volatile i64, ptr %.tag_addr1052 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %309 = and i64 %308, %.tag1053, !dbg !637
  %.tag_addr1056 = getelementptr inbounds i64, ptr %33, i64 -1, !dbg !637
  %.tag1057 = load atomic volatile i64, ptr %.tag_addr1056 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %310 = and i64 %309, %.tag1057, !dbg !637
  %.tag_addr1060 = getelementptr inbounds i64, ptr %35, i64 -1, !dbg !637
  %.tag1061 = load atomic volatile i64, ptr %.tag_addr1060 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %311 = and i64 %310, %.tag1061, !dbg !637
  %.tag_addr1064 = getelementptr inbounds i64, ptr %37, i64 -1, !dbg !637
  %.tag1065 = load atomic volatile i64, ptr %.tag_addr1064 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %312 = and i64 %311, %.tag1065, !dbg !637
  %.tag_addr1068 = getelementptr inbounds i64, ptr %39, i64 -1, !dbg !637
  %.tag1069 = load atomic volatile i64, ptr %.tag_addr1068 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %313 = and i64 %312, %.tag1069, !dbg !637
  %.tag_addr1072 = getelementptr inbounds i64, ptr %41, i64 -1, !dbg !637
  %.tag1073 = load atomic volatile i64, ptr %.tag_addr1072 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %314 = and i64 %313, %.tag1073, !dbg !637
  %.tag_addr1076 = getelementptr inbounds i64, ptr %43, i64 -1, !dbg !637
  %.tag1077 = load atomic volatile i64, ptr %.tag_addr1076 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %315 = and i64 %314, %.tag1077, !dbg !637
  %.tag_addr1080 = getelementptr inbounds i64, ptr %45, i64 -1, !dbg !637
  %.tag1081 = load atomic volatile i64, ptr %.tag_addr1080 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %316 = and i64 %315, %.tag1081, !dbg !637
  %.tag_addr1084 = getelementptr inbounds i64, ptr %47, i64 -1, !dbg !637
  %.tag1085 = load atomic volatile i64, ptr %.tag_addr1084 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %317 = and i64 %316, %.tag1085, !dbg !637
  %.tag_addr1088 = getelementptr inbounds i64, ptr %49, i64 -1, !dbg !637
  %.tag1089 = load atomic volatile i64, ptr %.tag_addr1088 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %318 = and i64 %317, %.tag1089, !dbg !637
  %.tag_addr1092 = getelementptr inbounds i64, ptr %51, i64 -1, !dbg !637
  %.tag1093 = load atomic volatile i64, ptr %.tag_addr1092 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %319 = and i64 %318, %.tag1093, !dbg !637
  %.tag_addr1096 = getelementptr inbounds i64, ptr %53, i64 -1, !dbg !637
  %.tag1097 = load atomic volatile i64, ptr %.tag_addr1096 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %320 = and i64 %319, %.tag1097, !dbg !637
  %.tag_addr1100 = getelementptr inbounds i64, ptr %55, i64 -1, !dbg !637
  %.tag1101 = load atomic volatile i64, ptr %.tag_addr1100 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %321 = and i64 %320, %.tag1101, !dbg !637
  %.tag_addr1104 = getelementptr inbounds i64, ptr %57, i64 -1, !dbg !637
  %.tag1105 = load atomic volatile i64, ptr %.tag_addr1104 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %322 = and i64 %321, %.tag1105, !dbg !637
  %.tag_addr1108 = getelementptr inbounds i64, ptr %59, i64 -1, !dbg !637
  %.tag1109 = load atomic volatile i64, ptr %.tag_addr1108 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %323 = and i64 %322, %.tag1109, !dbg !637
  %.tag_addr1112 = getelementptr inbounds i64, ptr %61, i64 -1, !dbg !637
  %.tag1113 = load atomic volatile i64, ptr %.tag_addr1112 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %324 = and i64 %323, %.tag1113, !dbg !637
  %.tag_addr1116 = getelementptr inbounds i64, ptr %253, i64 -1, !dbg !637
  %.tag1117 = load atomic volatile i64, ptr %.tag_addr1116 unordered, align 8, !dbg !637, !tbaa !281, !range !623
  %325 = and i64 %324, %.tag1117, !dbg !637
  %326 = and i64 %325, 1, !dbg !637
  %.not3.not = icmp eq i64 %326, 0, !dbg !637
  br i1 %.not3.not, label %trigger_wb1120, label %327, !dbg !637, !prof !630

trigger_wb1120:                                   ; preds = %may_trigger_wb981
  call void @ijl_gc_queue_root(ptr nonnull %"process::Process"), !dbg !637
  br label %327, !dbg !637

327:                                              ; preds = %may_trigger_wb981, %trigger_wb1120, %L717
...
L727:                                             ; preds = %327, %242
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(96) %sret_return, ptr noundef nonnull align 8 dereferenceable(96) %.sroa.0420.sroa.0, i64 96, i1 false), !dbg !616
  %.sroa.0426.sroa.2.0.sret_return.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 96, !dbg !616
  store i64 %.sroa.0.sroa.8.0, ptr %.sroa.0426.sroa.2.0.sret_return.sroa_idx, align 8, !dbg !616, !tbaa !277, !alias.scope !279, !noalias !280
  %.sroa.0426.sroa.3.0.sret_return.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 104, !dbg !616
  store i64 %.sroa.0.sroa.9.0, ptr %.sroa.0426.sroa.3.0.sret_return.sroa_idx, align 8, !dbg !616, !tbaa !277, !alias.scope !279, !noalias !280
  %.sroa.0426.sroa.4.0.sret_return.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 112, !dbg !616
  store i64 %.sroa.0.sroa.10.0, ptr %.sroa.0426.sroa.4.0.sret_return.sroa_idx, align 8, !dbg !616, !tbaa !277, !alias.scope !279, !noalias !280
  %.sroa.0426.sroa.5.0.sret_return.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 120, !dbg !616
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0426.sroa.5.0.sret_return.sroa_idx, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0420.sroa.9, i64 32, i1 false), !dbg !616
  %.sroa.0426.sroa.6.0.sret_return.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 152, !dbg !616
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(64) %.sroa.0426.sroa.6.0.sret_return.sroa_idx, ptr noundef nonnull align 8 dereferenceable(64) %.sroa.0420.sroa.10, i64 64, i1 false), !dbg !616
  %.sroa.0426.sroa.7.0.sret_return.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 216, !dbg !616
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0426.sroa.7.0.sret_return.sroa_idx, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0420.sroa.11, i64 32, i1 false), !dbg !616
  %.sroa.0426.sroa.8.0.sret_return.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 248, !dbg !616
  store i64 %.sroa.0.sroa.14.0, ptr %.sroa.0426.sroa.8.0.sret_return.sroa_idx, align 8, !dbg !616, !tbaa !277, !alias.scope !279, !noalias !280
  %.sroa.0426.sroa.9.0.sret_return.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 256, !dbg !616
  store i64 %.sroa.0.sroa.15.0, ptr %.sroa.0426.sroa.9.0.sret_return.sroa_idx, align 8, !dbg !616, !tbaa !277, !alias.scope !279, !noalias !280
  %.sroa.0426.sroa.10.0.sret_return.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 264, !dbg !616
  store i64 %.sroa.0.sroa.16.0, ptr %.sroa.0426.sroa.10.0.sret_return.sroa_idx, align 8, !dbg !616, !tbaa !277, !alias.scope !279, !noalias !280
  %.sroa.0426.sroa.11.0.sret_return.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 272, !dbg !616
  store i64 %.sroa.0.sroa.17.0, ptr %.sroa.0426.sroa.11.0.sret_return.sroa_idx, align 8, !dbg !616, !tbaa !277, !alias.scope !279, !noalias !280
  %.sroa.0426.sroa.12.0.sret_return.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 280, !dbg !616
  store i64 %.sroa.0.sroa.18.sroa.0.0, ptr %.sroa.0426.sroa.12.0.sret_return.sroa_idx, align 8, !dbg !616, !tbaa !277, !alias.scope !279, !noalias !280
  %.sroa.0426.sroa.12.sroa.2.0..sroa.0426.sroa.12.0.sret_return.sroa_idx.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 288, !dbg !616
  store i64 %.sroa.0.sroa.18.sroa.8.0, ptr %.sroa.0426.sroa.12.sroa.2.0..sroa.0426.sroa.12.0.sret_return.sroa_idx.sroa_idx, align 8, !dbg !616, !tbaa !277, !alias.scope !279, !noalias !280
  %.sroa.0426.sroa.12.sroa.3.0..sroa.0426.sroa.12.0.sret_return.sroa_idx.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 296, !dbg !616
  store float %.sroa.0.sroa.18.sroa.10.0, ptr %.sroa.0426.sroa.12.sroa.3.0..sroa.0426.sroa.12.0.sret_return.sroa_idx.sroa_idx, align 8, !dbg !616, !tbaa !277, !alias.scope !279, !noalias !280
  %.sroa.0426.sroa.12.sroa.4.0..sroa.0426.sroa.12.0.sret_return.sroa_idx.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 300, !dbg !616
  store float %.sroa.0.sroa.18.sroa.12.0, ptr %.sroa.0426.sroa.12.sroa.4.0..sroa.0426.sroa.12.0.sret_return.sroa_idx.sroa_idx, align 4, !dbg !616, !tbaa !277, !alias.scope !279, !noalias !280
  %.sroa.0426.sroa.12.sroa.5.0..sroa.0426.sroa.12.0.sret_return.sroa_idx.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 304, !dbg !616
  store i64 %.sroa.0.sroa.18.sroa.14.0, ptr %.sroa.0426.sroa.12.sroa.5.0..sroa.0426.sroa.12.0.sret_return.sroa_idx.sroa_idx, align 8, !dbg !616, !tbaa !277, !alias.scope !279, !noalias !280
  %.sroa.0426.sroa.12.sroa.6.0..sroa.0426.sroa.12.0.sret_return.sroa_idx.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 312, !dbg !616
  store i8 %.sroa.0.sroa.18.sroa.16.0, ptr %.sroa.0426.sroa.12.sroa.6.0..sroa.0426.sroa.12.0.sret_return.sroa_idx.sroa_idx, align 8, !dbg !616, !tbaa !277, !alias.scope !279, !noalias !280
  %.sroa.0426.sroa.12.sroa.7.0..sroa.0426.sroa.12.0.sret_return.sroa_idx.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 313, !dbg !616
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %.sroa.0426.sroa.12.sroa.7.0..sroa.0426.sroa.12.0.sret_return.sroa_idx.sroa_idx, ptr noundef nonnull align 1 dereferenceable(7) %.sroa.0420.sroa.16.sroa.16, i64 7, i1 false), !dbg !616
  %.sroa.2427.0.sret_return.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 320, !dbg !616
  store float %.sroa.8.0, ptr %.sroa.2427.0.sret_return.sroa_idx, align 8, !dbg !616, !tbaa !277, !alias.scope !279, !noalias !280
  %.sroa.3428.0.sret_return.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 324, !dbg !616
  store i32 %.sroa.10.0, ptr %.sroa.3428.0.sret_return.sroa_idx, align 4, !dbg !616, !tbaa !277, !alias.scope !279, !noalias !280
  %.sroa.4429.0.sret_return.sroa_idx = getelementptr inbounds i8, ptr %sret_return, i64 328, !dbg !616
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %.sroa.4429.0.sret_return.sroa_idx, ptr noundef nonnull align 8 dereferenceable(56) %.sroa.8425, i64 56, i1 false), !dbg !616
  ...
  %frame.prev1121 = load ptr, ptr %frame.prev, align 8, !tbaa !157
  store ptr %frame.prev1121, ptr %pgcstack, align 8, !tbaa !157
  ret void, !dbg !616

pass100:                                          ; preds = %guard_pass377, %guard_pass372
  %.sroa.9.0 = phi i8 [ 1, %guard_pass372 ], [ 0, %guard_pass377 ], !dbg !238
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %.sroa.6608, ptr noundef nonnull align 1 dereferenceable(7) %.sroa.10, i64 7, i1 false), !dbg !641
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %"new::NamedTuple.sroa.0.sroa.5", ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0432.sroa.11.0..sroa_idx671, i64 16, i1 false), !dbg !642, !tbaa !277, !alias.scope !279, !noalias !280
  ...
  %"new::SubContext.sroa.0.sroa.0.8.sroa_idx" = getelementptr inbounds i8, ptr %"new::SubContext.sroa.0.sroa.0", i64 8, !dbg !652
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(88) %"new::SubContext.sroa.0.sroa.0.8.sroa_idx", ptr noundef nonnull align 8 dereferenceable(88) %"new::NamedTuple.sroa.0.sroa.0", i64 88, i1 false), !dbg !652
  %"new::NamedTuple.sroa.0.sroa.5.144.sroa_idx" = getelementptr inbounds i8, ptr %"new::NamedTuple.sroa.0.sroa.5", i64 32, !dbg !652
  %"new::NamedTuple.sroa.0.sroa.5.208.sroa_idx" = getelementptr inbounds i8, ptr %"new::NamedTuple.sroa.0.sroa.5", i64 96, !dbg !652
  store i64 1, ptr %4, align 8, !dbg !657, !tbaa !204, !alias.scope !190, !noalias !191
  %356 = load <2 x i64>, ptr %"process::Process.loopidx_ptr", align 8, !dbg !665, !tbaa !204, !alias.scope !190, !noalias !191
  %357 = add <2 x i64> %356, <i64 1, i64 1>, !dbg !670
  store <2 x i64> %357, ptr %"process::Process.loopidx_ptr", align 8, !dbg !671, !tbaa !204, !alias.scope !190, !noalias !191
  %358 = load atomic i8, ptr %"process::Process.shouldrun_ptr" unordered, align 16, !dbg !672, !tbaa !204, !alias.scope !190, !noalias !191
  %359 = and i8 %358, 1, !dbg !672
  %"process::Process.shouldrun.not.not.not.not" = icmp eq i8 %359, 0, !dbg !672
  br i1 %"process::Process.shouldrun.not.not.not.not", label %L643, label %L644, !dbg !678
...
guard_pass362:                                    ; preds = %L131
  ...
  %unionalloca.sroa.0.0.unionalloca.sroa.0.0.unionalloca.sroa.0.0.unionalloca.sroa.0.0.copyload460792 = load i64, ptr %unionalloca.sroa.0, align 8, !dbg !336
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %unionalloca.sroa.0), !dbg !336
  %360 = trunc i64 %unionalloca.sroa.0.0.unionalloca.sroa.0.0.unionalloca.sroa.0.0.unionalloca.sroa.0.0.copyload460792 to i32, !dbg !679
  %361 = bitcast i32 %360 to float, !dbg !679
  call void @llvm.lifetime.start.p0(i64 7, ptr nonnull %.sroa.10655), !dbg !238
  br label %L262, !dbg !238

guard_pass367:                                    ; preds = %L216, %L214
  %value_phi314 = phi double [ %126, %L214 ], [ %spec.select384, %L216 ]
  %362 = fcmp ugt double %value_phi314, 2.000000e+00, !dbg !681
  %363 = fadd double %value_phi314, -1.000000e+00, !dbg !684
  %364 = fadd double %value_phi314, -2.000000e+00, !dbg !684
  %365 = fsub double 1.000000e+00, %364, !dbg !684
  %value_phi316 = select i1 %362, double %365, double %363, !dbg !684
  %366 = fptrunc double %value_phi316 to float, !dbg !685
  call void @llvm.lifetime.start.p0(i64 7, ptr nonnull %.sroa.10655), !dbg !238
  br label %L262, !dbg !238

guard_pass372:                                    ; preds = %L552
  %367 = load ptr, ptr %root_phi25.state80, align 8, !dbg !687, !tbaa !314, !alias.scope !317, !noalias !318
  %368 = getelementptr i8, ptr %367, i64 %memoryref_offset, !dbg !689
  %memoryref_data97 = getelementptr i8, ptr %368, i64 -4, !dbg !689
  store float %.sroa.7649.0, ptr %memoryref_data97, align 4, !dbg !689, !tbaa !322, !alias.scope !190, !noalias !191
