...
top:
  ...
  %1 = getelementptr inbounds ptr, ptr %gcframe2, i64 3
  ...
  fence syncscope("singlethread") seq_cst
  store i8 1, ptr @"jl_global#11095.jit", align 16, !dbg !172, !tbaa !187, !alias.scope !190, !noalias !191
  ...
  %66 = call i64 @jlplt_ijl_hrtime_11097_got.jit(), !dbg !206
...
L59.lr.ph:                                        ; preds = %L34.L38_crit_edge
  ...
  %87 = getelementptr inbounds ptr, ptr %gcframe2, i64 4
  %88 = getelementptr inbounds ptr, ptr %gcframe2, i64 5
  %89 = getelementptr inbounds ptr, ptr %gcframe2, i64 6
  %90 = getelementptr inbounds ptr, ptr %gcframe2, i64 7
...
L56:                                              ; preds = %L652, %L34.L38_crit_edge
  %92 = call swiftcc [1 x ptr] @j_ArgumentError_11098(ptr nonnull swiftself %pgcstack, ptr nonnull @"jl_global#11099.jit"), !dbg !255
  ...
  %"box::ArgumentError" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load956, i32 424, i32 16, i64 4908550128) #23, !dbg !255
  %"box::ArgumentError.tag_addr" = getelementptr inbounds i64, ptr %"box::ArgumentError", i64 -1, !dbg !255
  store atomic i64 4908550128, ptr %"box::ArgumentError.tag_addr" unordered, align 8, !dbg !255, !tbaa !281
...
L59:                                              ; preds = %L652, %L59.lr.ph
  ...
  %97 = call swiftcc i64 @j_rand_11101(ptr nonnull swiftself %pgcstack, ptr %47, ptr nocapture nonnull readonly %"new::SamplerRangeNDL"), !dbg !263
  %.fr785 = freeze i64 %97
...
L80:                                              ; preds = %L59
  call swiftcc void @j_throw_dmrsa_11102(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %root_phi25.state.size.0.copyload) #9, !dbg !311
  unreachable, !dbg !311
...
L139:                                             ; preds = %L136
  %104 = call swiftcc i64 @j_gen_rand_11109(ptr nonnull swiftself %pgcstack, ptr %47), !dbg !350
...
L197:                                             ; preds = %L141
  %122 = call swiftcc double @j_rem_internal_11113(ptr nonnull swiftself %pgcstack, double %121, double 4.000000e+00), !dbg !428
...
L244:                                             ; preds = %L85
  ...
  %"box::Float64" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load961, i32 424, i32 16, i64 4909129872) #23, !dbg !462
  %"box::Float64.tag_addr" = getelementptr inbounds i64, ptr %"box::Float64", i64 -1, !dbg !462
  store atomic i64 4909129872, ptr %"box::Float64.tag_addr" unordered, align 8, !dbg !462, !tbaa !281
  ...
  store ptr @"jl_global#11114.jit", ptr %jlcallframe1, align 8, !dbg !462
...
L317:                                             ; preds = %L262
  ...
  call swiftcc void @j_throw_boundserror_11111(ptr nonnull swiftself %pgcstack, ptr %9, ptr nocapture nonnull readonly %"new::Tuple290") #9, !dbg !470
  unreachable, !dbg !470
...
L320:                                             ; preds = %L262
  ...
  %137 = call swiftcc double @"j_#power_by_squaring#401_11105"(ptr nonnull swiftself %pgcstack, double %136, i64 signext 2), !dbg !487
...
L342:                                             ; preds = %L320
  ...
  store ptr %root_phi6.state, ptr %gc_slot_addr_7947, align 8
  call swiftcc void @j_throw_boundserror_11111(ptr nonnull swiftself %pgcstack, ptr nonnull %root_phi6.state, ptr nocapture nonnull readonly %"new::Tuple288") #9, !dbg !470
  unreachable, !dbg !470
...
L345:                                             ; preds = %L320
  ...
  %142 = call swiftcc double @"j_#power_by_squaring#401_11105"(ptr nonnull swiftself %pgcstack, double %141, i64 signext 2), !dbg !487
  ...
  %148 = call swiftcc float @"j_#calculate##0_11106"(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %"new::#calculate##0#calculate##1", ptr nocapture nonnull readonly %0, float %147, ptr nocapture nonnull readonly %86, ptr nocapture nonnull readonly %1), !dbg !456
...
L400:                                             ; preds = %L345
  %150 = getelementptr inbounds ptr, ptr %gcframe2, i64 2
  store i64 %.fr785, ptr %"new::Tuple67", align 1, !dbg !447, !tbaa !277, !alias.scope !279, !noalias !280
  store ptr %25, ptr %150, align 8, !dbg !507
  call swiftcc void @j_throw_boundserror_11112(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %.sroa.0433.sroa.9.0..sroa_idx660, ptr nocapture nonnull readonly %150, ptr nocapture nonnull readonly %"new::Tuple67") #9, !dbg !507
  unreachable, !dbg !507
...
L417:                                             ; preds = %L403
  ...
  call swiftcc void @j_throw_boundserror_11111(ptr nonnull swiftself %pgcstack, ptr nonnull %root_phi6.state65, ptr nocapture nonnull readonly %"new::Tuple285") #9, !dbg !511
  unreachable, !dbg !511
...
L438:                                             ; preds = %L435
  %158 = call swiftcc i64 @j_gen_rand_11109(ptr nonnull swiftself %pgcstack, ptr %47), !dbg !525
...
L560:                                             ; preds = %L552
  call swiftcc void @j_throw_dmrsa_11102(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %root_phi25.state80.size.0.copyload) #9, !dbg !609
  unreachable, !dbg !609
...
L662:                                             ; preds = %L648.L653_crit_edge, %L642, %L34.L653_crit_edge
  ...
  %199 = call i64 @jlplt_ijl_hrtime_11097_got.jit(), !dbg !611
  ...
  %exactly_isa.not.not = icmp eq ptr %201, @"+Core.Nothing#11107.jit", !dbg !619
...
L699:                                             ; preds = %L662
  ...
  %"box::ProcessContext" = call noalias nonnull align 8 dereferenceable(400) ptr @ijl_gc_small_alloc(ptr %ptls_load969, i32 1120, i32 400, i64 15439692560) #23, !dbg !624
  %"box::ProcessContext.tag_addr" = getelementptr inbounds i64, ptr %"box::ProcessContext", i64 -1, !dbg !624
  store atomic i64 15439692560, ptr %"box::ProcessContext.tag_addr" unordered, align 8, !dbg !624, !tbaa !281
