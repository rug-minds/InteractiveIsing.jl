...
top:
  ...
  fence syncscope("singlethread") seq_cst
  store i8 1, ptr @"jl_global#10239.jit", align 16, !dbg !171, !tbaa !181, !alias.scope !184, !noalias !185
  ...
  %66 = call i64 @jlplt_ijl_hrtime_10241_got.jit(), !dbg !200
...
L58:                                              ; preds = %L663, %L34.L38_crit_edge
  %92 = call swiftcc [1 x ptr] @j_ArgumentError_10242(ptr nonnull swiftself %pgcstack, ptr nonnull @"jl_global#10243.jit"), !dbg !266
  ...
  %"box::ArgumentError" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load1026, i32 424, i32 16, i64 5004543984) #24, !dbg !266
  %"box::ArgumentError.tag_addr" = getelementptr inbounds i64, ptr %"box::ArgumentError", i64 -1, !dbg !266
  store atomic i64 5004543984, ptr %"box::ArgumentError.tag_addr" unordered, align 8, !dbg !266, !tbaa !292
...
L61:                                              ; preds = %L663, %L61.lr.ph
  ...
  %97 = call swiftcc i64 @j_rand_10245(ptr nonnull swiftself %pgcstack, ptr %47, ptr nocapture nonnull readonly %"new::SamplerRangeNDL"), !dbg !274
  %.fr855 = freeze i64 %97
...
L82:                                              ; preds = %L61
  call swiftcc void @j_throw_dmrsa_10246(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %root_phi25.state.size.0.copyload) #9, !dbg !322
  unreachable, !dbg !322
...
L141:                                             ; preds = %L138
  %104 = call swiftcc i64 @j_gen_rand_10253(ptr nonnull swiftself %pgcstack, ptr %47), !dbg !361
...
L199:                                             ; preds = %L143
  %122 = call swiftcc double @j_rem_internal_10257(ptr nonnull swiftself %pgcstack, double %121, double 4.000000e+00), !dbg !439
...
L246:                                             ; preds = %L87
  ...
  %"box::Float64" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load1031, i32 424, i32 16, i64 5005123728) #24, !dbg !473
  %"box::Float64.tag_addr" = getelementptr inbounds i64, ptr %"box::Float64", i64 -1, !dbg !473
  store atomic i64 5005123728, ptr %"box::Float64.tag_addr" unordered, align 8, !dbg !473, !tbaa !292
  ...
  store ptr @"jl_global#10258.jit", ptr %jlcallframe1, align 8, !dbg !473
...
L319:                                             ; preds = %L264
  ...
  call swiftcc void @j_throw_boundserror_10255(ptr nonnull swiftself %pgcstack, ptr %9, ptr nocapture nonnull readonly %"new::Tuple353") #9, !dbg !481
  unreachable, !dbg !481
...
L322:                                             ; preds = %L264
  ...
  %137 = call swiftcc double @"j_#power_by_squaring#401_10249"(ptr nonnull swiftself %pgcstack, double %136, i64 signext 2), !dbg !498
...
L344:                                             ; preds = %L322
  ...
  store ptr %root_phi6.state, ptr %gc_slot_addr_71017, align 8
  call swiftcc void @j_throw_boundserror_10255(ptr nonnull swiftself %pgcstack, ptr nonnull %root_phi6.state, ptr nocapture nonnull readonly %"new::Tuple351") #9, !dbg !481
  unreachable, !dbg !481
...
L347:                                             ; preds = %L322
  ...
  %142 = call swiftcc double @"j_#power_by_squaring#401_10249"(ptr nonnull swiftself %pgcstack, double %141, i64 signext 2), !dbg !498
  ...
  %148 = call swiftcc float @"j_#calculate##0_10250"(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %"new::#calculate##0#calculate##1", ptr nocapture nonnull readonly %0, float %147, ptr nocapture nonnull readonly %86, ptr nocapture nonnull readonly %1), !dbg !467
...
L402:                                             ; preds = %L347
  ...
  call swiftcc void @j_throw_boundserror_10256(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %.sroa.0496.sroa.9.0..sroa_idx730, ptr nocapture nonnull readonly %150, ptr nocapture nonnull readonly %"new::Tuple101") #9, !dbg !518
  unreachable, !dbg !518
...
L419:                                             ; preds = %L405
  ...
  call swiftcc void @j_throw_boundserror_10255(ptr nonnull swiftself %pgcstack, ptr nonnull %root_phi6.state99, ptr nocapture nonnull readonly %"new::Tuple348") #9, !dbg !522
  unreachable, !dbg !522
...
L440:                                             ; preds = %L437
  %158 = call swiftcc i64 @j_gen_rand_10253(ptr nonnull swiftself %pgcstack, ptr %47), !dbg !536
...
L562:                                             ; preds = %L554
  call swiftcc void @j_throw_dmrsa_10246(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %root_phi25.state114.size.0.copyload) #9, !dbg !620
  unreachable, !dbg !620
...
L664:                                             ; preds = %L659.L664_crit_edge, %L653, %L34.L664_crit_edge
  ...
  %203 = call i64 @jlplt_ijl_hrtime_10241_got.jit(), !dbg !662
  ...
  %exactly_isa.not.not = icmp eq ptr %205, @"+Core.Nothing#10251.jit", !dbg !670
...
L701:                                             ; preds = %L664
  ...
  %"box::ProcessContext" = call noalias nonnull align 8 dereferenceable(400) ptr @ijl_gc_small_alloc(ptr %ptls_load1039, i32 1120, i32 400, i64 13133650256) #24, !dbg !675
  %"box::ProcessContext.tag_addr" = getelementptr inbounds i64, ptr %"box::ProcessContext", i64 -1, !dbg !675
  store atomic i64 13133650256, ptr %"box::ProcessContext.tag_addr" unordered, align 8, !dbg !675, !tbaa !292
