...
top:
  ...
  fence syncscope("singlethread") seq_cst
  store i8 1, ptr @"jl_global#9796.jit", align 32, !dbg !172, !tbaa !187, !alias.scope !190, !noalias !191
  ...
  %66 = call i64 @jlplt_ijl_hrtime_9798_got.jit(), !dbg !206
...
L56:                                              ; preds = %L649, %L34.L38_crit_edge
  %92 = call swiftcc [1 x ptr] @j_ArgumentError_9799(ptr nonnull swiftself %pgcstack, ptr nonnull @"jl_global#9800.jit"), !dbg !255
  ...
  %"box::ArgumentError" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load956, i32 424, i32 16, i64 4841261040) #23, !dbg !255
  %"box::ArgumentError.tag_addr" = getelementptr inbounds i64, ptr %"box::ArgumentError", i64 -1, !dbg !255
  store atomic i64 4841261040, ptr %"box::ArgumentError.tag_addr" unordered, align 8, !dbg !255, !tbaa !281
...
L59:                                              ; preds = %L649, %L59.lr.ph
  ...
  %97 = call swiftcc i64 @j_rand_9802(ptr nonnull swiftself %pgcstack, ptr %47, ptr nocapture nonnull readonly %"new::SamplerRangeNDL"), !dbg !263
  %.fr785 = freeze i64 %97
...
L80:                                              ; preds = %L59
  call swiftcc void @j_throw_dmrsa_9803(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %root_phi25.state.size.0.copyload) #9, !dbg !311
  unreachable, !dbg !311
...
L139:                                             ; preds = %L136
  %104 = call swiftcc i64 @j_gen_rand_9810(ptr nonnull swiftself %pgcstack, ptr %47), !dbg !350
...
L197:                                             ; preds = %L141
  %122 = call swiftcc double @j_rem_internal_9814(ptr nonnull swiftself %pgcstack, double %121, double 4.000000e+00), !dbg !428
...
L244:                                             ; preds = %L85
  ...
  %"box::Float64" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load961, i32 424, i32 16, i64 4841840784) #23, !dbg !462
  %"box::Float64.tag_addr" = getelementptr inbounds i64, ptr %"box::Float64", i64 -1, !dbg !462
  store atomic i64 4841840784, ptr %"box::Float64.tag_addr" unordered, align 8, !dbg !462, !tbaa !281
  ...
  store ptr @"jl_global#9815.jit", ptr %jlcallframe1, align 8, !dbg !462
...
L317:                                             ; preds = %L262
  ...
  call swiftcc void @j_throw_boundserror_9812(ptr nonnull swiftself %pgcstack, ptr %9, ptr nocapture nonnull readonly %"new::Tuple290") #9, !dbg !470
  unreachable, !dbg !470
...
L320:                                             ; preds = %L262
  ...
  %137 = call swiftcc double @"j_#power_by_squaring#401_9806"(ptr nonnull swiftself %pgcstack, double %136, i64 signext 2), !dbg !487
...
L342:                                             ; preds = %L320
  ...
  store ptr %root_phi6.state, ptr %gc_slot_addr_7947, align 8
  call swiftcc void @j_throw_boundserror_9812(ptr nonnull swiftself %pgcstack, ptr nonnull %root_phi6.state, ptr nocapture nonnull readonly %"new::Tuple288") #9, !dbg !470
  unreachable, !dbg !470
...
L345:                                             ; preds = %L320
  ...
  %142 = call swiftcc double @"j_#power_by_squaring#401_9806"(ptr nonnull swiftself %pgcstack, double %141, i64 signext 2), !dbg !487
  ...
  %148 = call swiftcc float @"j_#calculate##0_9807"(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %"new::#calculate##0#calculate##1", ptr nocapture nonnull readonly %1, float %147, ptr nocapture nonnull readonly %86, ptr nocapture nonnull readonly %0), !dbg !456
...
L400:                                             ; preds = %L345
  ...
  call swiftcc void @j_throw_boundserror_9813(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %.sroa.0433.sroa.9.0..sroa_idx660, ptr nocapture nonnull readonly %150, ptr nocapture nonnull readonly %"new::Tuple67") #9, !dbg !507
  unreachable, !dbg !507
...
L417:                                             ; preds = %L403
  ...
  call swiftcc void @j_throw_boundserror_9812(ptr nonnull swiftself %pgcstack, ptr nonnull %root_phi6.state65, ptr nocapture nonnull readonly %"new::Tuple285") #9, !dbg !511
  unreachable, !dbg !511
...
L438:                                             ; preds = %L435
  %158 = call swiftcc i64 @j_gen_rand_9810(ptr nonnull swiftself %pgcstack, ptr %47), !dbg !525
...
L560:                                             ; preds = %L552
  call swiftcc void @j_throw_dmrsa_9803(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %root_phi25.state80.size.0.copyload) #9, !dbg !609
  unreachable, !dbg !609
...
L659:                                             ; preds = %L645.L650_crit_edge, %L639, %L34.L650_crit_edge
  ...
  %199 = call i64 @jlplt_ijl_hrtime_9798_got.jit(), !dbg !611
  ...
  %exactly_isa.not.not = icmp eq ptr %201, @"+Core.Nothing#9808.jit", !dbg !619
...
L696:                                             ; preds = %L659
  ...
  %"box::ProcessContext" = call noalias nonnull align 8 dereferenceable(400) ptr @ijl_gc_small_alloc(ptr %ptls_load969, i32 1120, i32 400, i64 13104410000) #23, !dbg !624
  %"box::ProcessContext.tag_addr" = getelementptr inbounds i64, ptr %"box::ProcessContext", i64 -1, !dbg !624
  store atomic i64 13104410000, ptr %"box::ProcessContext.tag_addr" unordered, align 8, !dbg !624, !tbaa !281
