...
top:
  ...
  %1 = getelementptr inbounds ptr, ptr %gcframe2, i64 12
  %2 = getelementptr inbounds ptr, ptr %gcframe2, i64 7
  ...
  fence syncscope("singlethread") seq_cst
  store i8 1, ptr @"jl_global#9453.jit", align 16, !dbg !171, !tbaa !186, !alias.scope !189, !noalias !190
  ...
  %68 = call i64 @jlplt_ijl_hrtime_9455_got.jit(), !dbg !205
...
L34:                                              ; preds = %top
  %71 = call swiftcc [1 x ptr] @j_ArgumentError_9456(ptr nonnull swiftself %pgcstack, ptr nonnull @"jl_global#9457.jit"), !dbg !246
  ...
  %"box::ArgumentError" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load1285, i32 424, i32 16, i64 4867540976) #23, !dbg !246
  %"box::ArgumentError.tag_addr" = getelementptr inbounds i64, ptr %"box::ArgumentError", i64 -1, !dbg !246
  store atomic i64 4867540976, ptr %"box::ArgumentError.tag_addr" unordered, align 8, !dbg !246, !tbaa !273
...
L37:                                              ; preds = %top
  ...
  %76 = call swiftcc i64 @j_rand_9459(ptr nonnull swiftself %pgcstack, ptr %49, ptr nocapture nonnull readonly %"new::SamplerRangeNDL"), !dbg !254
...
L58:                                              ; preds = %L37
  call swiftcc void @j_throw_dmrsa_9460(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %.state.size.0.copyload) #8, !dbg !307
  unreachable, !dbg !307
...
L117:                                             ; preds = %L114
  %84 = call swiftcc i64 @j_gen_rand_9468(ptr nonnull swiftself %pgcstack, ptr %49), !dbg !347
...
L175:                                             ; preds = %L119
  %102 = call swiftcc double @j_rem_internal_9472(ptr nonnull swiftself %pgcstack, double %101, double 4.000000e+00), !dbg !425
...
L222:                                             ; preds = %L63
  ...
  %"box::Float64503" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load1290, i32 424, i32 16, i64 4868120720) #23, !dbg !445
  %"box::Float64503.tag_addr" = getelementptr inbounds i64, ptr %"box::Float64503", i64 -1, !dbg !445
  store atomic i64 4868120720, ptr %"box::Float64503.tag_addr" unordered, align 8, !dbg !445, !tbaa !273
  ...
  store ptr @"jl_global#9473.jit", ptr %jlcallframe1, align 8, !dbg !445
...
L295:                                             ; preds = %L240
  ...
  call swiftcc void @j_throw_boundserror_9470(ptr nonnull swiftself %pgcstack, ptr %11, ptr nocapture nonnull readonly %"new::Tuple468") #8, !dbg !474
  unreachable, !dbg !474
...
L298:                                             ; preds = %L240
  ...
  %121 = call swiftcc double @"j_#power_by_squaring#401_9463"(ptr nonnull swiftself %pgcstack, double %120, i64 signext 2), !dbg !485
...
L320:                                             ; preds = %L298
  ...
  call swiftcc void @j_throw_boundserror_9470(ptr nonnull swiftself %pgcstack, ptr nonnull %.state21, ptr nocapture nonnull readonly %"new::Tuple466") #8, !dbg !474
  unreachable, !dbg !474
...
L323:                                             ; preds = %L298
  ...
  %126 = call swiftcc double @"j_#power_by_squaring#401_9463"(ptr nonnull swiftself %pgcstack, double %125, i64 signext 2), !dbg !485
  ...
  %132 = getelementptr inbounds ptr, ptr %gcframe2, i64 3, !dbg !471
  store ptr %19, ptr %132, align 8, !dbg !471
  %133 = getelementptr inbounds ptr, ptr %gcframe2, i64 4, !dbg !471
  store ptr %21, ptr %133, align 8, !dbg !471
  %134 = getelementptr inbounds ptr, ptr %gcframe2, i64 5, !dbg !471
  store ptr %23, ptr %134, align 8, !dbg !471
  %135 = getelementptr inbounds ptr, ptr %gcframe2, i64 6, !dbg !471
  store ptr %25, ptr %135, align 8, !dbg !471
  %136 = call swiftcc float @"j_#calculate##0_9464"(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %"new::#calculate##0#calculate##1", ptr nocapture nonnull readonly %1, float %131, ptr nocapture nonnull readonly %115, ptr nocapture nonnull readonly %3), !dbg !471
...
L378:                                             ; preds = %L323
  %139 = getelementptr inbounds ptr, ptr %gcframe2, i64 14
  %140 = getelementptr inbounds i8, ptr %"context::ProcessContext", i64 104, !dbg !526
  store ptr %27, ptr %139, align 8, !dbg !519
  call swiftcc void @j_throw_boundserror_9471(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %140, ptr nocapture nonnull readonly %139, ptr nocapture nonnull readonly %"new::Tuple43") #8, !dbg !519
  unreachable, !dbg !519
...
L395:                                             ; preds = %L381
  ...
  call swiftcc void @j_throw_boundserror_9470(ptr nonnull swiftself %pgcstack, ptr nonnull %.state41, ptr nocapture nonnull readonly %"new::Tuple463") #8, !dbg !532
  unreachable, !dbg !532
...
L416:                                             ; preds = %L413
  %148 = call swiftcc i64 @j_gen_rand_9468(ptr nonnull swiftself %pgcstack, ptr %49), !dbg !546
...
L538:                                             ; preds = %L530
  call swiftcc void @j_throw_dmrsa_9460(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %.state56.size.0.copyload) #8, !dbg !630
  unreachable, !dbg !630
...
L673.lr.ph:                                       ; preds = %L639.L643_crit_edge
  ...
  %196 = getelementptr inbounds ptr, ptr %gcframe2, i64 8
  %197 = getelementptr inbounds ptr, ptr %gcframe2, i64 9
  %198 = getelementptr inbounds ptr, ptr %gcframe2, i64 10
  %199 = getelementptr inbounds ptr, ptr %gcframe2, i64 11
...
L670:                                             ; preds = %L1271, %L639.L643_crit_edge
  %201 = call swiftcc [1 x ptr] @j_ArgumentError_9456(ptr nonnull swiftself %pgcstack, ptr nonnull @"jl_global#9457.jit"), !dbg !650
  ...
  %"box::ArgumentError121" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load1297, i32 424, i32 16, i64 4867540976) #23, !dbg !650
  %"box::ArgumentError121.tag_addr" = getelementptr inbounds i64, ptr %"box::ArgumentError121", i64 -1, !dbg !650
  store atomic i64 4867540976, ptr %"box::ArgumentError121.tag_addr" unordered, align 8, !dbg !650, !tbaa !273
...
L673:                                             ; preds = %L1271, %L673.lr.ph
  ...
  %206 = call swiftcc i64 @j_rand_9459(ptr nonnull swiftself %pgcstack, ptr %49, ptr nocapture nonnull readonly %"new::SamplerRangeNDL126"), !dbg !653
  %.fr = freeze i64 %206
...
L694:                                             ; preds = %L673
  call swiftcc void @j_throw_dmrsa_9460(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %root_phi106.state.size.0.copyload) #8, !dbg !671
  unreachable, !dbg !671
...
L753:                                             ; preds = %L750
  %213 = call swiftcc i64 @j_gen_rand_9468(ptr nonnull swiftself %pgcstack, ptr %49), !dbg !689
...
L811:                                             ; preds = %L755
  %231 = call swiftcc double @j_rem_internal_9472(ptr nonnull swiftself %pgcstack, double %230, double 4.000000e+00), !dbg !741
...
L858:                                             ; preds = %L699
  ...
  %"box::Float64" = call noalias nonnull align 8 dereferenceable(16) ptr @ijl_gc_small_alloc(ptr %ptls_load1302, i32 424, i32 16, i64 4868120720) #23, !dbg !761
  %"box::Float64.tag_addr" = getelementptr inbounds i64, ptr %"box::Float64", i64 -1, !dbg !761
  store atomic i64 4868120720, ptr %"box::Float64.tag_addr" unordered, align 8, !dbg !761, !tbaa !273
  ...
  store ptr @"jl_global#9473.jit", ptr %jlcallframe1, align 8, !dbg !761
...
L931:                                             ; preds = %L876
  ...
  call swiftcc void @j_throw_boundserror_9470(ptr nonnull swiftself %pgcstack, ptr nonnull %11, ptr nocapture nonnull readonly %"new::Tuple395") #8, !dbg !767
  unreachable, !dbg !767
...
L934:                                             ; preds = %L876
  ...
  %246 = call swiftcc double @"j_#power_by_squaring#401_9463"(ptr nonnull swiftself %pgcstack, double %245, i64 signext 2), !dbg !777
...
L956:                                             ; preds = %L934
  ...
  store ptr %root_phi87.state, ptr %gc_slot_addr_141269, align 8
  call swiftcc void @j_throw_boundserror_9470(ptr nonnull swiftself %pgcstack, ptr nonnull %root_phi87.state, ptr nocapture nonnull readonly %"new::Tuple393") #8, !dbg !767
  unreachable, !dbg !767
...
L959:                                             ; preds = %L934
  ...
  store ptr null, ptr %gc_slot_addr_141269, align 8
  %251 = call swiftcc double @"j_#power_by_squaring#401_9463"(ptr nonnull swiftself %pgcstack, double %250, i64 signext 2), !dbg !777
  ...
  store ptr %17, ptr %2, align 8, !dbg !757
  ...
  %257 = call swiftcc float @"j_#calculate##0_9464"(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %"new::#calculate##0#calculate##1163", ptr nocapture nonnull readonly %0, float %256, ptr nocapture nonnull readonly %195, ptr nocapture nonnull readonly %2), !dbg !757
...
L1014:                                            ; preds = %L959
  %259 = getelementptr inbounds ptr, ptr %gcframe2, i64 13
  store i64 %.fr, ptr %"new::Tuple186", align 1, !dbg !754, !tbaa !283, !alias.scope !285, !noalias !286
  store ptr %27, ptr %259, align 8, !dbg !789
  call swiftcc void @j_throw_boundserror_9471(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly %.sroa.0682.sroa.9.0..sroa_idx942, ptr nocapture nonnull readonly %259, ptr nocapture nonnull readonly %"new::Tuple186") #8, !dbg !789
  unreachable, !dbg !789
...
L1031:                                            ; preds = %L1017
  ...
  call swiftcc void @j_throw_boundserror_9470(ptr nonnull swiftself %pgcstack, ptr nonnull %root_phi87.state184, ptr nocapture nonnull readonly %"new::Tuple390") #8, !dbg !793
  unreachable, !dbg !793
...
L1052:                                            ; preds = %L1049
  %267 = call swiftcc i64 @j_gen_rand_9468(ptr nonnull swiftself %pgcstack, ptr %49), !dbg !805
...
L1174:                                            ; preds = %L1166
  call swiftcc void @j_throw_dmrsa_9460(ptr nonnull swiftself %pgcstack, ptr nocapture nonnull readonly @"_j_const#3", i64 signext %root_phi106.state199.size.0.copyload) #8, !dbg !874
  unreachable, !dbg !874
...
L1272:                                            ; preds = %L1267.L1272_crit_edge, %L1261, %L639.L1272_crit_edge
  ...
  %308 = call i64 @jlplt_ijl_hrtime_9455_got.jit(), !dbg !876
  ...
  %exactly_isa.not.not = icmp eq ptr %310, @"+Core.Nothing#9466.jit", !dbg !884
...
L1308:                                            ; preds = %L1272
  ...
  %"box::ProcessContext" = call noalias nonnull align 8 dereferenceable(400) ptr @ijl_gc_small_alloc(ptr %ptls_load1310, i32 1120, i32 400, i64 13693166672) #23, !dbg !889
  %"box::ProcessContext.tag_addr" = getelementptr inbounds i64, ptr %"box::ProcessContext", i64 -1, !dbg !889
  store atomic i64 13693166672, ptr %"box::ProcessContext.tag_addr" unordered, align 8, !dbg !889, !tbaa !273
