# Should be about 16.3-16.4 secs
# Updates per second: 5.905361669040044e7
using InteractiveIsing, Processes
g = IsingGraph(10, 10, 10, type = Discrete)
createProcess(g, lifetime = 1000000000)
fetch(process(g))
println("Time: ", Processes.runtime(process(g)))
li = loopint(process(g))
ups = li/Processes.runtime(process(g))
