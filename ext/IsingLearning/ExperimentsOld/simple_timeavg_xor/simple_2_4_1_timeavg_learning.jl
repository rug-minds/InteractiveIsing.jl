...
"""
struct DerivativeAverager <: StatefulAlgorithms.ProcessAlgorithm
    sign::Int
end

StatefulAlgorithms.init(::DerivativeAverager, context) = (; count = 0)

function StatefulAlgorithms.step!(averager::DerivativeAverager, context)
    graph = context.model
