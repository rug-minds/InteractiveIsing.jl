...
$series = Join-Path $root "experiments\current\20260607_lcl_6x6_stochastic_ep_response_grid"
...
$common = @{
    ...
    "ISING_MNIST_LCL_STOCHASTIC_SAMPLES" = "4"
}

$runs = @(
    @{ name = "b0p1_lr0p0001_T0p001_s25_k4_e80"; beta = "0.1"; lr = "0.0001" },
    @{ name = "b0p3_lr0p0001_T0p001_s25_k4_e80"; beta = "0.3"; lr = "0.0001" },
    @{ name = "b0p3_lr0p0003_T0p001_s25_k4_e80"; beta = "0.3"; lr = "0.0003" },
    @{ name = "b1p0_lr0p0003_T0p001_s25_k4_e80"; beta = "1.0"; lr = "0.0003" }
)
