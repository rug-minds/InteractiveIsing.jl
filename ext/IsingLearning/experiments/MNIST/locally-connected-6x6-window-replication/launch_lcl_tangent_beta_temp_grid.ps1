...
$Root = Join-Path $ScriptDir ("experiments\current\" + $Stamp + "_lcl_6x6_tangent_beta_temp_grid")
...
function Invoke-LclRun {
    ...
    if (-not (Test-Path $manifest)) {
        "timestamp,name,beta,lr,temp,sweeps,epochs,train_per_class,test_per_class,outdir" | Out-File -FilePath $manifest -Encoding utf8
    }
    "$(Get-Date -Format s),$name,$Beta,$LearningRate,$Temp,$Sweeps,$Epochs,100,40,$outdir" | Out-File -FilePath $manifest -Append -Encoding utf8
...
$runs = @(
    @{ Beta = "1.0"; LearningRate = "0.0001";  Temp = "0.001"; Sweeps = "25"; Epochs = "120" },
    @{ Beta = "1.0"; LearningRate = "0.0003";  Temp = "0.001"; Sweeps = "25"; Epochs = "120" },
    @{ Beta = "3.0"; LearningRate = "0.00003"; Temp = "0.001"; Sweeps = "25"; Epochs = "120" },
    @{ Beta = "3.0"; LearningRate = "0.0001";  Temp = "0.001"; Sweeps = "25"; Epochs = "120" },
    @{ Beta = "1.0"; LearningRate = "0.0001";  Temp = "0.01";  Sweeps = "25"; Epochs = "120" },
    @{ Beta = "3.0"; LearningRate = "0.00003"; Temp = "0.01";  Sweeps = "25"; Epochs = "120" }
)
