...
$Root = Join-Path $ScriptDir ("experiments\current\" + $Stamp + "_lcl_6x6_tangent_low_beta_calibration_grid")
...
function Invoke-LclRun {
    ...
    $name = "lcl6x6_tangent_b$(Format-Token $Beta)_lr$(Format-Token $LearningRate)_T$(Format-Token $Temp)_ws$(Format-Token $WeightScale)_s$(Format-Token $Sweeps)_train$TrainPerClass`_e$Epochs"
    ...
    if ($exit -ne 0) {
        throw "LCL low-beta calibration run $name failed with exit code $exit"
    }
}

# Calibrate the nudge scale against colder equilibrium temperatures.
# The beta=3 row is a short control against the prior high-beta learning/collapse regime.
Invoke-LclRun -Beta "0.1" -LearningRate "0.00005" -Temp "0.0001" -Sweeps "25" -Epochs "120"
Invoke-LclRun -Beta "0.1" -LearningRate "0.00010" -Temp "0.0003" -Sweeps "25" -Epochs "120"
Invoke-LclRun -Beta "0.3" -LearningRate "0.00010" -Temp "0.0001" -Sweeps "25" -Epochs "120"
Invoke-LclRun -Beta "0.3" -LearningRate "0.00020" -Temp "0.0003" -Sweeps "25" -Epochs "120"
Invoke-LclRun -Beta "0.3" -LearningRate "0.00020" -Temp "0.0010" -Sweeps "25" -Epochs "120"
Invoke-LclRun -Beta "1.0" -LearningRate "0.00030" -Temp "0.0003" -Sweeps "25" -Epochs "120"
Invoke-LclRun -Beta "1.0" -LearningRate "0.00030" -Temp "0.0010" -Sweeps "25" -Epochs "120"
Invoke-LclRun -Beta "3.0" -LearningRate "0.00050" -Temp "0.0010" -Sweeps "25" -Epochs "120"
