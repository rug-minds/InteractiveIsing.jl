...
$attempt = Join-Path $series "attempt_02_metropolis_s25_beta2p5_lr0001_b128_chunk4_seed2468_e40"

New-Item -ItemType Directory -Force -Path $attempt | Out-Null

$env:ISING_MNIST_PM_NAME = "r8_rescue_metropolis_s25_beta2p5_lr0001_b128_chunk4_seed2468_e40"
$env:ISING_MNIST_PM_OUTDIR = $attempt
$env:ISING_MNIST_PM_RADII = "8"
$env:ISING_MNIST_PM_RADIUS = "8"
$env:ISING_MNIST_PM_WORKERS = "32"
$env:ISING_MNIST_PM_EPOCHS = "40"
...
$env:ISING_MNIST_PM_LR_W0 = "0.0001"
$env:ISING_MNIST_PM_LR_W12 = "0.0001"
$env:ISING_MNIST_PM_LR_W2O = "0.0001"
$env:ISING_MNIST_PM_LR_B = "0.00001"
