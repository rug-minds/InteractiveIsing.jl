...
$status = Join-Path $logdir "more_sweeps_small_beta_status.log"
...
function Run-R8 {
    ...
    $outdir = Configure-R8 -Attempt $Attempt -Name $Name -Epochs $Epochs -Sweeps $Sweeps -Beta $Beta -Lr $Lr -LrBias $LrBias -Seed $Seed
...
Run-R8 -Attempt "a13_s35_b15_lr25_e160" -Name "r8_s35_b15_lr25_e160" -Epochs 160 -Sweeps 35 -Beta "1.5" -Lr "0.000025" -LrBias "0.0000025" -Seed 2468
Run-R8 -Attempt "a14_s35_b10_lr25_e160" -Name "r8_s35_b10_lr25_e160" -Epochs 160 -Sweeps 35 -Beta "1.0" -Lr "0.000025" -LrBias "0.0000025" -Seed 2468
Run-R8 -Attempt "a15_s50_b10_lr10_e200" -Name "r8_s50_b10_lr10_e200" -Epochs 200 -Sweeps 50 -Beta "1.0" -Lr "0.00001" -LrBias "0.000001" -Seed 2468
Run-R8 -Attempt "a16_s50_b075_lr10_e200" -Name "r8_s50_b075_lr10_e200" -Epochs 200 -Sweeps 50 -Beta "0.75" -Lr "0.00001" -LrBias "0.000001" -Seed 2468

Add-Content -Path $status -Value "[$(Get-Date -Format s)] MORE SWEEPS SMALL BETA COMPLETE"
