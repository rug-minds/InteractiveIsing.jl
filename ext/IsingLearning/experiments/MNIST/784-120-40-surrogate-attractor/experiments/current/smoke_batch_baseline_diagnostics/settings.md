...
- learning step: batch-baseline reward covariance over sampled attractors
- transition probabilities: logged as diagnostics; nonzero transition weight power is a heuristic ablation
...
- reward mode/surrogate temp/transition weight power: `logprob` / `1.0` / `0.0`
- gradient sign: `1.0`
