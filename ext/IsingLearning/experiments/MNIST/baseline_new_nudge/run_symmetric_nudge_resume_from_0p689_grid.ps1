...
$Checkpoint = "ext/IsingLearning/experiments/MNIST/baseline_new_nudge/experiments/current/symmetric_nudge_resume_from_v4_best_20260609/resume_lr0p00015_reset/best_checkpoint.bin"
$GridRoot = "ext/IsingLearning/experiments/MNIST/baseline_new_nudge/experiments/current/symmetric_nudge_resume_from_0p689_20260610"
...
$Runs = @(
    @{ name = "cont_lr0p00015_keepadam_s500"; beta = "0.020"; lr = "0.00015"; temp = "0.00005"; wd = "0.001"; stepsize = "0.5"; sweeps = "500"; posw = "9.0"; negw = "0.50"; reset = "false" },
    @{ name = "cont_lr0p00012_reset_s500"; beta = "0.020"; lr = "0.00012"; temp = "0.00005"; wd = "0.001"; stepsize = "0.5"; sweeps = "500"; posw = "9.0"; negw = "0.50"; reset = "true" },
    @{ name = "cont_lr0p00015_keepadam_s750"; beta = "0.020"; lr = "0.00015"; temp = "0.00005"; wd = "0.001"; stepsize = "0.5"; sweeps = "750"; posw = "9.0"; negw = "0.50"; reset = "false" }
)
