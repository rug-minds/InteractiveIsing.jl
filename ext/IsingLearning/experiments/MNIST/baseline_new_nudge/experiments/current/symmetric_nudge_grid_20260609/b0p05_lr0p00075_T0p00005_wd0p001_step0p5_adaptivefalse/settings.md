...
- early stop minimum batches: `100`
...
- optimiser: `Optimisers.Adam(0.00075)`
- epochs/batchsize: `8` / `128`
- train/test per class: `1280` / `100`
- train eval per class: `100`
- sweeps/relaxation steps: `500.0` / `80000`
- beta/nudge tau/temp/stepsize: `0.05` / `0.25` / `5.0e-5` / `0.5`
...
- adaptive decay targets w/w_input: `2.0` / `4.0`
- adaptive decay gain/max: `0.001` / `0.003`
- resume from: `none`
- resume epoch: `-1`
