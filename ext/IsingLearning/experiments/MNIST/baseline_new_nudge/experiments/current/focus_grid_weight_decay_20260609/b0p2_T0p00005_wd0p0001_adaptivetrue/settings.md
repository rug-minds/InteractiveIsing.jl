...
- beta/nudge tau/temp/stepsize: `0.2` / `0.25` / `5.0e-5` / `0.5`
...
- adaptive weight decay: `true`
- adaptive decay targets w/w_input: `1.8` / `5.0`
- adaptive decay gain/max: `0.00075` / `0.003`
- resume from: `none`
- resume epoch: `-1`
