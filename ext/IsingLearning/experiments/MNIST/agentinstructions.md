...
- Keep `ProcessAlgorithm`s atomic. Manage phase sequencing, nested learning flow, and repeated temperature/dynamics blocks with `StatefulAlgorithms.@Routine` or `StatefulAlgorithms.@CompositeAlgorithm`, following `ext/IsingLearning/experiments/AGENTS.md`.
