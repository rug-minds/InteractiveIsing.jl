...
|---|---:|---:|---|---|
| `simple_local_s020_d035_T020_b10` | 0.874838 | 0.75 | no | split-snapshot Langevin: mode=local_langevin, side=2, hidden=4, stepsize=0.2, max_drift=0.35, Tfactor=0.02, β=1.0, free=500, early=40, nudged=700, nudged_T_bump=3.0 |
| `simple_local_s040_d060_T020_b10` | 1.009734 | 0.5 | no | split-snapshot Langevin: mode=local_langevin, side=2, hidden=4, stepsize=0.4, max_drift=0.6, Tfactor=0.02, β=1.0, free=500, early=30, nudged=800, nudged_T_bump=4.0 |
